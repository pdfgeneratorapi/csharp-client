...
namespace PDFGeneratorAPI.Client.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is InlineObject21.MessageEnum inlineObject21MessageEnum)
                return InlineObject21.MessageEnumToJsonValue(inlineObject21MessageEnum);
            if (obj is InlineObject22.MessageEnum inlineObject22MessageEnum)
                return InlineObject22.MessageEnumToJsonValue(inlineObject22MessageEnum);
