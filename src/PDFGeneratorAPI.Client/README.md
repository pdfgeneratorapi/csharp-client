...
inputSpec: /home/runner/work/sdk-generator/sdk-generator/spec/apiv4.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{E453DA0B-7E58-4EAA-A217-CA81C53D04EF}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGenerateQRCodeApiResponse apiResponse = await api.GenerateQRCodeAsync("todo");
            GenerateQRCode201Response? model = apiResponse.Ok();
        }
