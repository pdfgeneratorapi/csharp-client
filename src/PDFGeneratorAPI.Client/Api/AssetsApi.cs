...
namespace PDFGeneratorAPI.Client.Api
{
    ...
    public interface IAssetsApi : IApi
    {
        ...
        /// <param name="generateQRCodeRequest">QR Code configuration</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGenerateQRCodeApiResponse"/>&gt;</returns>
        Task<IGenerateQRCodeApiResponse> GenerateQRCodeAsync(GenerateQRCodeRequest generateQRCodeRequest, System.Threading.CancellationToken cancellationToken = default);
    ...
    public class AssetsApiEvents
    {
        ...
        internal void ExecuteOnGenerateQRCode(AssetsApi.GenerateQRCodeApiResponse apiResponse)
        {
    ...
    public sealed partial class AssetsApi : IAssetsApi
    {
        ...
        partial void FormatGenerateQRCode(GenerateQRCodeRequest generateQRCodeRequest);
        ...
        /// <returns></returns>
        private void ValidateGenerateQRCode(GenerateQRCodeRequest generateQRCodeRequest)
        {
            if (generateQRCodeRequest == null)
                throw new ArgumentNullException(nameof(generateQRCodeRequest));
        }
        ...
        /// <param name="generateQRCodeRequest"></param>
        private void AfterGenerateQRCodeDefaultImplementation(IGenerateQRCodeApiResponse apiResponseLocalVar, GenerateQRCodeRequest generateQRCodeRequest)
        {
            bool suppressDefaultLog = false;
            AfterGenerateQRCode(ref suppressDefaultLog, apiResponseLocalVar, generateQRCodeRequest);
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="generateQRCodeRequest"></param>
        partial void AfterGenerateQRCode(ref bool suppressDefaultLog, IGenerateQRCodeApiResponse apiResponseLocalVar, GenerateQRCodeRequest generateQRCodeRequest);
        ...
        /// <param name="generateQRCodeRequest"></param>
        private void OnErrorGenerateQRCodeDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, GenerateQRCodeRequest generateQRCodeRequest)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGenerateQRCode(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, generateQRCodeRequest);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="generateQRCodeRequest"></param>
        partial void OnErrorGenerateQRCode(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, GenerateQRCodeRequest generateQRCodeRequest);

        /// <summary>
        /// Generate QR Code Creates a QR code based on the configuration
        /// </summary>
        /// <param name="generateQRCodeRequest">QR Code configuration</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGenerateQRCodeApiResponse"/>&gt;</returns>
        public async Task<IGenerateQRCodeApiResponse?> GenerateQRCodeOrDefaultAsync(GenerateQRCodeRequest generateQRCodeRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GenerateQRCodeAsync(generateQRCodeRequest, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGenerateQRCodeApiResponse"/>&gt;</returns>
        public async Task<IGenerateQRCodeApiResponse> GenerateQRCodeAsync(GenerateQRCodeRequest generateQRCodeRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGenerateQRCode(generateQRCodeRequest);

                FormatGenerateQRCode(generateQRCodeRequest);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/assets/qrcode"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath, "/assets/qrcode");

                    httpRequestMessageLocalVar.Content = (generateQRCodeRequest as object) is System.IO.Stream stream
                        ? httpRequestMessageLocalVar.Content = new StreamContent(stream)
                        : httpRequestMessageLocalVar.Content = new StringContent(JsonSerializer.Serialize(generateQRCodeRequest, _jsonSerializerOptions));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GenerateQRCodeApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/assets/qrcode", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGenerateQRCodeDefaultImplementation(apiResponseLocalVar, generateQRCodeRequest);
            ...
            {
                OnErrorGenerateQRCodeDefaultImplementation(e, "/assets/qrcode", uriBuilderLocalVar.Path, generateQRCodeRequest);
        ...
        /// </summary>
        public partial class GenerateQRCodeApiResponse : PDFGeneratorAPI.Client.Client.ApiResponse, IGenerateQRCodeApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public PDFGeneratorAPI.Client.Model.GenerateQRCode201Response? Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<PDFGeneratorAPI.Client.Model.GenerateQRCode201Response>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryCreated([NotNullWhen(true)]out PDFGeneratorAPI.Client.Model.GenerateQRCode201Response? result)
            {
                result = null;
