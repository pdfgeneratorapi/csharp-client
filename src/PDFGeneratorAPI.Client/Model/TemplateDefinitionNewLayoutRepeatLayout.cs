...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateDefinitionNewLayoutRepeatLayout : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinitionNewLayoutRepeatLayout" /> class.
        /// </summary>
        /// <param name="format">Defines template page size</param>
        /// <param name="width">Page width in units</param>
        /// <param name="height">Page height in units</param>
        [JsonConstructor]
        public TemplateDefinitionNewLayoutRepeatLayout(Option<FormatEnum?> format = default, Option<decimal?> width = default, Option<decimal?> height = default)
        {
            FormatOption = format;
            WidthOption = width;
            HeightOption = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateDefinitionNewLayoutRepeatLayout {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateDefinitionNewLayoutRepeatLayout" />
    /// </summary>
    public class TemplateDefinitionNewLayoutRepeatLayoutJsonConverter : JsonConverter<TemplateDefinitionNewLayoutRepeatLayout>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateDefinitionNewLayoutRepeatLayout" />
        /// </summary>
        ...
        public override TemplateDefinitionNewLayoutRepeatLayout Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TemplateDefinitionNewLayoutRepeatLayout.FormatEnum?> format = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "format":
                            ...
                            if (formatRawValue != null)
                                format = new Option<TemplateDefinitionNewLayoutRepeatLayout.FormatEnum?>(TemplateDefinitionNewLayoutRepeatLayout.FormatEnumFromStringOrDefault(formatRawValue));
                            break;
                        case "width":
            ...
            if (format.IsSet && format.Value == null)
                throw new ArgumentNullException(nameof(format), "Property is not nullable for class TemplateDefinitionNewLayoutRepeatLayout.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class TemplateDefinitionNewLayoutRepeatLayout.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class TemplateDefinitionNewLayoutRepeatLayout.");

            return new TemplateDefinitionNewLayoutRepeatLayout(format, width, height);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateDefinitionNewLayoutRepeatLayout" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewLayoutRepeatLayout"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateDefinitionNewLayoutRepeatLayout templateDefinitionNewLayoutRepeatLayout, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateDefinitionNewLayoutRepeatLayout, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateDefinitionNewLayoutRepeatLayout" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewLayoutRepeatLayout"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateDefinitionNewLayoutRepeatLayout templateDefinitionNewLayoutRepeatLayout, JsonSerializerOptions jsonSerializerOptions)
        {
            var formatRawValue = TemplateDefinitionNewLayoutRepeatLayout.FormatEnumToJsonValue(templateDefinitionNewLayoutRepeatLayout.FormatOption.Value!.Value);
            writer.WriteString("format", formatRawValue);
            if (templateDefinitionNewLayoutRepeatLayout.WidthOption.IsSet)
                writer.WriteNumber("width", templateDefinitionNewLayoutRepeatLayout.WidthOption.Value!.Value);

            if (templateDefinitionNewLayoutRepeatLayout.HeightOption.IsSet)
                writer.WriteNumber("height", templateDefinitionNewLayoutRepeatLayout.HeightOption.Value!.Value);
        }
    }
}
