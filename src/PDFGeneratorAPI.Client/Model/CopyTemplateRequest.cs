...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// CopyTemplateRequest
    /// </summary>
    public partial class CopyTemplateRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CopyTemplateRequest(Option<string?> name = default)
        {
            NameOption = name;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Name for the copied template. If name is not specified then the original name is used.</value>
        /* <example>My copied template</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="CopyTemplateRequest" />
    /// </summary>
    public class CopyTemplateRequestJsonConverter : JsonConverter<CopyTemplateRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CopyTemplateRequest" />
        /// </summary>
        ...
        public override CopyTemplateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CopyTemplateRequest.");

            return new CopyTemplateRequest(name);
        }

        /// <summary>
        /// Serializes a <see cref="CopyTemplateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="copyTemplateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CopyTemplateRequest copyTemplateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, copyTemplateRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CopyTemplateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="copyTemplateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CopyTemplateRequest copyTemplateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (copyTemplateRequest.NameOption.IsSet && copyTemplateRequest.Name == null)
                throw new ArgumentNullException(nameof(copyTemplateRequest.Name), "Property is required for class CopyTemplateRequest.");

            if (copyTemplateRequest.NameOption.IsSet)
                writer.WriteString("name", copyTemplateRequest.Name);
        }
    }
}
