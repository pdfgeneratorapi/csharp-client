...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class FormFieldsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFieldsInner" /> class.
        /// </summary>
        /// <param name="label">Field label displayed in the form</param>
        /// <param name="name">Data field name. For example \&quot;name\&quot; can be used as \&quot;{name}\&quot; in the document as placeholder.</param>
        /// <param name="type">Field type</param>
        /// <param name="required">Specifies if the field is required or not</param>
        [JsonConstructor]
        public FormFieldsInner(Option<string?> label = default, Option<string?> name = default, Option<TypeEnum?> type = default, Option<bool?> required = default)
        {
            LabelOption = label;
            NameOption = name;
            TypeOption = type;
        ...
        /// </summary>
        /// <value>Field label displayed in the form</value>
        ...
        /// </summary>
        /// <value>Data field name. For example \&quot;name\&quot; can be used as \&quot;{name}\&quot; in the document as placeholder.</value>
        ...
        /// </summary>
        /// <value>Specifies if the field is required or not</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormFieldsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormFieldsInner" />
    /// </summary>
    public class FormFieldsInnerJsonConverter : JsonConverter<FormFieldsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormFieldsInner" />
        /// </summary>
        ...
        public override FormFieldsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<FormFieldsInner.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<FormFieldsInner.TypeEnum?>(FormFieldsInner.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "required":
            ...
            if (label.IsSet && label.Value == null)
                throw new ArgumentNullException(nameof(label), "Property is not nullable for class FormFieldsInner.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class FormFieldsInner.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class FormFieldsInner.");

            if (required.IsSet && required.Value == null)
                throw new ArgumentNullException(nameof(required), "Property is not nullable for class FormFieldsInner.");

            return new FormFieldsInner(label, name, type, required);
        }

        /// <summary>
        /// Serializes a <see cref="FormFieldsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFieldsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormFieldsInner formFieldsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formFieldsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormFieldsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFieldsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormFieldsInner formFieldsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formFieldsInner.LabelOption.IsSet && formFieldsInner.Label == null)
                throw new ArgumentNullException(nameof(formFieldsInner.Label), "Property is required for class FormFieldsInner.");

            if (formFieldsInner.NameOption.IsSet && formFieldsInner.Name == null)
                throw new ArgumentNullException(nameof(formFieldsInner.Name), "Property is required for class FormFieldsInner.");

            if (formFieldsInner.LabelOption.IsSet)
                writer.WriteString("label", formFieldsInner.Label);

            if (formFieldsInner.NameOption.IsSet)
                writer.WriteString("name", formFieldsInner.Name);

            var typeRawValue = FormFieldsInner.TypeEnumToJsonValue(formFieldsInner.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (formFieldsInner.RequiredOption.IsSet)
                writer.WriteBoolean("required", formFieldsInner.RequiredOption.Value!.Value);
        }
    }
}
