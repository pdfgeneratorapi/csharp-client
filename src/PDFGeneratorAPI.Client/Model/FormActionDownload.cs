...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class FormActionDownload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormActionDownload" /> class.
        /// </summary>
        /// <param name="downloadDocument">downloadDocument</param>
        [JsonConstructor]
        public FormActionDownload(Option<bool?> downloadDocument = default)
        {
            DownloadDocumentOption = downloadDocument;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of DownloadDocument
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> DownloadDocumentOption { get; private set; }

        /// <summary>
        /// Gets or Sets DownloadDocument
        /// </summary>
        /* <example>true</example> */
        [JsonPropertyName("download_document")]
        public bool? DownloadDocument { get { return this.DownloadDocumentOption; } set { this.DownloadDocumentOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormActionDownload {\n");
            sb.Append("  DownloadDocument: ").Append(DownloadDocument).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormActionDownload" />
    /// </summary>
    public class FormActionDownloadJsonConverter : JsonConverter<FormActionDownload>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormActionDownload" />
        /// </summary>
        ...
        public override FormActionDownload Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> downloadDocument = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "download_document":
                            downloadDocument = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (downloadDocument.IsSet && downloadDocument.Value == null)
                throw new ArgumentNullException(nameof(downloadDocument), "Property is not nullable for class FormActionDownload.");

            return new FormActionDownload(downloadDocument);
        }

        /// <summary>
        /// Serializes a <see cref="FormActionDownload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formActionDownload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormActionDownload formActionDownload, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formActionDownload, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormActionDownload" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formActionDownload"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormActionDownload formActionDownload, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formActionDownload.DownloadDocumentOption.IsSet)
                writer.WriteBoolean("download_document", formActionDownload.DownloadDocumentOption.Value!.Value);
        }
    }
}
