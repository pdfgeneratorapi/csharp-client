...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject1 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject1(Option<InlineObject1Response?> response = default)
        {
        ...
        public Option<InlineObject1Response?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public InlineObject1Response? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject1JsonConverter : JsonConverter<InlineObject1>
    {
        ...
        public override InlineObject1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject1Response?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<InlineObject1Response?>(JsonSerializer.Deserialize<InlineObject1Response>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject1.");

            return new InlineObject1(response);
        }
        ...
        {
            if (inlineObject1.ResponseOption.IsSet && inlineObject1.Response == null)
                throw new ArgumentNullException(nameof(inlineObject1.Response), "Property is required for class InlineObject1.");

            if (inlineObject1.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject1.Response, jsonSerializerOptions);
            }
        }
    }
}
