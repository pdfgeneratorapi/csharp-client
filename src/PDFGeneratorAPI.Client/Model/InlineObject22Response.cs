...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class InlineObject22Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject22Response" /> class.
        /// </summary>
        /// <param name="jobId">Unique job id which is also added to the callback request as header PDF-API-Job-Id</param>
        [JsonConstructor]
        public InlineObject22Response(Option<string?> jobId = default)
        {
            JobIdOption = jobId;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Unique job id which is also added to the callback request as header PDF-API-Job-Id</value>
        /* <example>JeLjz9MKNyAwIG9iago8PCA</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObject22Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject22Response" />
    /// </summary>
    public class InlineObject22ResponseJsonConverter : JsonConverter<InlineObject22Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject22Response" />
        /// </summary>
        ...
        public override InlineObject22Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (jobId.IsSet && jobId.Value == null)
                throw new ArgumentNullException(nameof(jobId), "Property is not nullable for class InlineObject22Response.");

            return new InlineObject22Response(jobId);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject22Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject22Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject22Response inlineObject22Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject22Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject22Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject22Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject22Response inlineObject22Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject22Response.JobIdOption.IsSet && inlineObject22Response.JobId == null)
                throw new ArgumentNullException(nameof(inlineObject22Response.JobId), "Property is required for class InlineObject22Response.");

            if (inlineObject22Response.JobIdOption.IsSet)
                writer.WriteString("job_id", inlineObject22Response.JobId);
        }
    }
}
