...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject18
    /// </summary>
    public partial class InlineObject18 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject18" /> class.
        /// </summary>
        /// <param name="response">Public URL for form data collection</param>
        /// <param name="meta">meta</param>
        [JsonConstructor]
        public InlineObject18(Option<string?> response = default, Option<InlineObject18Meta?> meta = default)
        {
        ...
        /// </summary>
        /// <value>Public URL for form data collection</value>
        /* <example>https://app.pdfgeneratorapi.com/forms/097475c4-dcd5-42ca-814f-b9fa3da66b5a/share</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObject18Meta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObject18Meta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject18" />
    /// </summary>
    public class InlineObject18JsonConverter : JsonConverter<InlineObject18>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject18" />
        /// </summary>
        ...
        public override InlineObject18 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject18Meta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObject18Meta?>(JsonSerializer.Deserialize<InlineObject18Meta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject18.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject18.");

            return new InlineObject18(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject18" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject18"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject18 inlineObject18, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject18, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject18" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject18"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject18 inlineObject18, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject18.ResponseOption.IsSet && inlineObject18.Response == null)
                throw new ArgumentNullException(nameof(inlineObject18.Response), "Property is required for class InlineObject18.");

            if (inlineObject18.MetaOption.IsSet && inlineObject18.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject18.Meta), "Property is required for class InlineObject18.");

            if (inlineObject18.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject18.Response);

            if (inlineObject18.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject18.Meta, jsonSerializerOptions);
            }
        }
    }
}
