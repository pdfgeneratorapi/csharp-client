...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class PaginationMeta : IValidatableObject
    {
        ...
        [JsonConstructor]
        public PaginationMeta(Option<decimal?> currentPage = default, Option<decimal?> lastPage = default, Option<decimal?> perPage = default)
        {
        ...
        public Option<decimal?> CurrentPageOption { get; private set; }
        ...
        public decimal? CurrentPage { get { return this.CurrentPageOption; } set { this.CurrentPageOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<decimal?> LastPageOption { get; private set; }
        ...
        public decimal? LastPage { get { return this.LastPageOption; } set { this.LastPageOption = new(value); } }
        ...
        public decimal? PerPage { get { return this.PerPageOption; } set { this.PerPageOption = new(value); } }
    ...
    public class PaginationMetaJsonConverter : JsonConverter<PaginationMeta>
    {
        ...
        public override PaginationMeta Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<decimal?> lastPage = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "current_page":
                            ...
                            break;
                        case "last_page":
                            lastPage = new Option<decimal?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (decimal?)null : utf8JsonReader.GetDecimal());
                            break;
                        case "per_page":
            ...
            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class PaginationMeta.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class PaginationMeta.");

            return new PaginationMeta(currentPage, lastPage, perPage);
        }
        ...
        {
            if (paginationMeta.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", paginationMeta.CurrentPageOption.Value!.Value);

            if (paginationMeta.LastPageOption.IsSet)
                writer.WriteNumber("last_page", paginationMeta.LastPageOption.Value!.Value);

            if (paginationMeta.PerPageOption.IsSet)
                writer.WriteNumber("per_page", paginationMeta.PerPageOption.Value!.Value);
        }
    }
}
