...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// <summary>
    /// Converts <see cref="WatermarkPosition"/> to and from the JSON value
    /// </summary>
    public static class WatermarkPositionValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="WatermarkPosition"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static WatermarkPosition FromString(string value)
        {
            if (value.Equals("top-left"))
                return WatermarkPosition.TopLeft;

            if (value.Equals("top-center"))
            ...
            if (value.Equals("bottom-center"))
                return WatermarkPosition.BottomCenter;

            if (value.Equals("bottom-right"))
                return WatermarkPosition.BottomRight;

            throw new NotImplementedException($"Could not convert value to type WatermarkPosition: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static WatermarkPosition? FromStringOrDefault(string value)
        {
            if (value.Equals("top-left"))
                return WatermarkPosition.TopLeft;
        ...
        /// <summary>
        /// Converts the <see cref="WatermarkPosition"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(WatermarkPosition value)
        {
            if (value == WatermarkPosition.TopLeft)
                return "top-left";

            if (value == WatermarkPosition.TopCenter)
                return "top-center";

            if (value == WatermarkPosition.TopRight)
                return "top-right";

            if (value == WatermarkPosition.Left)
                return "left";

            if (value == WatermarkPosition.Center)
                return "center";

            if (value == WatermarkPosition.Right)
                return "right";

            if (value == WatermarkPosition.BottomLeft)
                return "bottom-left";

            if (value == WatermarkPosition.BottomCenter)
                return "bottom-center";

            if (value == WatermarkPosition.BottomRight)
                return "bottom-right";
    ...
    /// <summary>
    /// A Json converter for type <see cref="WatermarkPosition"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class WatermarkPositionJsonConverter : JsonConverter<WatermarkPosition>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override WatermarkPosition Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            WatermarkPosition? result = rawValue == null
                ? null
                : WatermarkPositionValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the WatermarkPosition to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="watermarkPosition"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, WatermarkPosition watermarkPosition, JsonSerializerOptions options)
        {
            writer.WriteStringValue(watermarkPosition.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="WatermarkPosition"/>
    /// </summary>
    public class WatermarkPositionNullableJsonConverter : JsonConverter<WatermarkPosition?>
    {
        /// <summary>
        /// Returns a WatermarkPosition from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, WatermarkPosition? watermarkPosition, JsonSerializerOptions options)
        {
            writer.WriteStringValue(watermarkPosition?.ToString() ?? "null");
        }
    }
}
