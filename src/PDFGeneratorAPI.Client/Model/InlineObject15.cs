...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject15
    /// </summary>
    public partial class InlineObject15 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject15(Option<List<Document>?> response = default, Option<PaginationMeta?> meta = default)
        {
        ...
        public Option<List<Document>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<Document>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject15" />
    /// </summary>
    public class InlineObject15JsonConverter : JsonConverter<InlineObject15>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject15" />
        /// </summary>
        ...
        public override InlineObject15 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Document>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<Document>?>(JsonSerializer.Deserialize<List<Document>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject15.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject15.");

            return new InlineObject15(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject15" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject15"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject15 inlineObject15, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject15, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject15" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject15"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject15 inlineObject15, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject15.ResponseOption.IsSet && inlineObject15.Response == null)
                throw new ArgumentNullException(nameof(inlineObject15.Response), "Property is required for class InlineObject15.");

            if (inlineObject15.MetaOption.IsSet && inlineObject15.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject15.Meta), "Property is required for class InlineObject15.");

            if (inlineObject15.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject15.Response, jsonSerializerOptions);
            }
            if (inlineObject15.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject15.Meta, jsonSerializerOptions);
            }
        }
    }
}
