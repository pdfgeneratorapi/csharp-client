...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// DataBatchInner
    /// </summary>
    public partial class DataBatchInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataBatchInner" /> class.
        /// </summary>
        /// <param name="template">Template id</param>
        /// <param name="data">JSON data used to replace data fields in the template</param>
        [JsonConstructor]
        public DataBatchInner(Option<int?> template = default, Option<Object?> data = default)
        {
        ...
        public Option<int?> TemplateOption { get; private set; }
        ...
        public int? Template { get { return this.TemplateOption; } set { this.TemplateOption = new(value); } }
        ...
        /// </summary>
        /// <value>JSON data used to replace data fields in the template</value>
        /* <example>{&quot;id&quot;:123,&quot;name&quot;:&quot;John Smith&quot;,&quot;birthdate&quot;:&quot;2000-01-01&quot;,&quot;role&quot;:&quot;Developer&quot;}</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataBatchInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DataBatchInner" />
    /// </summary>
    public class DataBatchInnerJsonConverter : JsonConverter<DataBatchInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="DataBatchInner" />
        /// </summary>
        ...
        public override DataBatchInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "template":
                            template = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "data":
            ...
            if (template.IsSet && template.Value == null)
                throw new ArgumentNullException(nameof(template), "Property is not nullable for class DataBatchInner.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class DataBatchInner.");

            return new DataBatchInner(template, data);
        }

        /// <summary>
        /// Serializes a <see cref="DataBatchInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dataBatchInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DataBatchInner dataBatchInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dataBatchInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DataBatchInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dataBatchInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DataBatchInner dataBatchInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dataBatchInner.DataOption.IsSet && dataBatchInner.Data == null)
                throw new ArgumentNullException(nameof(dataBatchInner.Data), "Property is required for class DataBatchInner.");

            if (dataBatchInner.TemplateOption.IsSet)
                writer.WriteNumber("template", dataBatchInner.TemplateOption.Value!.Value);

            if (dataBatchInner.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, dataBatchInner.Data, jsonSerializerOptions);
            }
        }
    }
}
