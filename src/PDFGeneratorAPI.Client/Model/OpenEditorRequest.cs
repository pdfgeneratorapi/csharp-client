...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// OpenEditorRequest
    /// </summary>
    public partial class OpenEditorRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenEditorRequest" /> class.
        /// </summary>
        /// <param name="data">data</param>
        /// <param name="language">Specify the editor UI language. Defaults to organization editor language.</param>
        [JsonConstructor]
        public OpenEditorRequest(Option<OpenEditorRequestData?> data = default, Option<LanguageEnum?> language = default)
        {
            DataOption = data;
        ...
        /// </summary>
        /// <value>Specify the editor UI language. Defaults to organization editor language.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<OpenEditorRequestData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public OpenEditorRequestData? Data { get { return this.DataOption; } set { this.DataOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenEditorRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="OpenEditorRequest" />
    /// </summary>
    public class OpenEditorRequestJsonConverter : JsonConverter<OpenEditorRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="OpenEditorRequest" />
        /// </summary>
        ...
        public override OpenEditorRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<OpenEditorRequestData?> data = default;
            Option<OpenEditorRequest.LanguageEnum?> language = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "data":
                            data = new Option<OpenEditorRequestData?>(JsonSerializer.Deserialize<OpenEditorRequestData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "language":
                            string? languageRawValue = utf8JsonReader.GetString();
                            if (languageRawValue != null)
                                language = new Option<OpenEditorRequest.LanguageEnum?>(OpenEditorRequest.LanguageEnumFromStringOrDefault(languageRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class OpenEditorRequest.");

            if (language.IsSet && language.Value == null)
                throw new ArgumentNullException(nameof(language), "Property is not nullable for class OpenEditorRequest.");

            return new OpenEditorRequest(data, language);
        }

        /// <summary>
        /// Serializes a <see cref="OpenEditorRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="openEditorRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OpenEditorRequest openEditorRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, openEditorRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OpenEditorRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="openEditorRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OpenEditorRequest openEditorRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (openEditorRequest.DataOption.IsSet && openEditorRequest.Data == null)
                throw new ArgumentNullException(nameof(openEditorRequest.Data), "Property is required for class OpenEditorRequest.");

            if (openEditorRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, openEditorRequest.Data, jsonSerializerOptions);
            }
            var languageRawValue = OpenEditorRequest.LanguageEnumToJsonValue(openEditorRequest.LanguageOption.Value!.Value);
