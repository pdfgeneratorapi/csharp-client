...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class FillFormFieldsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FillFormFieldsRequest" /> class.
        /// </summary>
        /// <param name="formFillUrl"></param>
        public FillFormFieldsRequest(FormFillUrl formFillUrl)
        {
        ...
        public FillFormFieldsRequest(FormFillBase64 formFillBase64)
        {
            FormFillBase64 = formFillBase64;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets FormFillUrl
        /// </summary>
        public FormFillUrl? FormFillUrl { get; set; }

        /// <summary>
        /// Gets or Sets FormFillBase64
        /// </summary>
        public FormFillBase64? FormFillBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FillFormFieldsRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="FillFormFieldsRequest" />
    /// </summary>
    public class FillFormFieldsRequestJsonConverter : JsonConverter<FillFormFieldsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="FillFormFieldsRequest" />
        /// </summary>
        ...
        public override FillFormFieldsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            FormFillUrl? formFillUrl = default;
            FormFillBase64? formFillBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderFormFillUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<FormFillUrl?>(ref utf8JsonReaderFormFillUrl, jsonSerializerOptions, out formFillUrl);

                    Utf8JsonReader utf8JsonReaderFormFillBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<FormFillBase64?>(ref utf8JsonReaderFormFillBase64, jsonSerializerOptions, out formFillBase64);
                }
            }
            ...
            if (formFillUrl != null)
                return new FillFormFieldsRequest(formFillUrl);

            if (formFillBase64 != null)
                return new FillFormFieldsRequest(formFillBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="FillFormFieldsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fillFormFieldsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FillFormFieldsRequest fillFormFieldsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fillFormFieldsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FillFormFieldsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fillFormFieldsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FillFormFieldsRequest fillFormFieldsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
