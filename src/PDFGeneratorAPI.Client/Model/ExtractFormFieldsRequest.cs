...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class ExtractFormFieldsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtractFormFieldsRequest" /> class.
        /// </summary>
        /// <param name="formFieldsUrl"></param>
        public ExtractFormFieldsRequest(FormFieldsUrl formFieldsUrl)
        {
            FormFieldsUrl = formFieldsUrl;
            OnCreated();
        }
        ...
        public ExtractFormFieldsRequest(FormFieldsBase64 formFieldsBase64)
        {
            FormFieldsBase64 = formFieldsBase64;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets FormFieldsUrl
        /// </summary>
        public FormFieldsUrl? FormFieldsUrl { get; set; }

        /// <summary>
        /// Gets or Sets FormFieldsBase64
        /// </summary>
        public FormFieldsBase64? FormFieldsBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtractFormFieldsRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ExtractFormFieldsRequest" />
    /// </summary>
    public class ExtractFormFieldsRequestJsonConverter : JsonConverter<ExtractFormFieldsRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="ExtractFormFieldsRequest" />
        /// </summary>
        ...
        public override ExtractFormFieldsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            FormFieldsUrl? formFieldsUrl = default;
            FormFieldsBase64? formFieldsBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderFormFieldsUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<FormFieldsUrl?>(ref utf8JsonReaderFormFieldsUrl, jsonSerializerOptions, out formFieldsUrl);

                    Utf8JsonReader utf8JsonReaderFormFieldsBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<FormFieldsBase64?>(ref utf8JsonReaderFormFieldsBase64, jsonSerializerOptions, out formFieldsBase64);
                }
            }
            ...
            if (formFieldsUrl != null)
                return new ExtractFormFieldsRequest(formFieldsUrl);

            if (formFieldsBase64 != null)
                return new ExtractFormFieldsRequest(formFieldsBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="ExtractFormFieldsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="extractFormFieldsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ExtractFormFieldsRequest extractFormFieldsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, extractFormFieldsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ExtractFormFieldsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="extractFormFieldsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ExtractFormFieldsRequest extractFormFieldsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
