...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// <summary>
    /// Converts <see cref="StatusParam"/> to and from the JSON value
    /// </summary>
    public static class StatusParamValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="StatusParam"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static StatusParam FromString(string value)
        {
            if (value.Equals("ok"))
                return StatusParam.Ok;

            if (value.Equals("failed"))
                return StatusParam.Failed;

            throw new NotImplementedException($"Could not convert value to type StatusParam: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static StatusParam? FromStringOrDefault(string value)
        {
            if (value.Equals("ok"))
                return StatusParam.Ok;
        ...
        /// <summary>
        /// Converts the <see cref="StatusParam"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(StatusParam value)
        {
            if (value == StatusParam.Ok)
                return "ok";

            if (value == StatusParam.Failed)
                return "failed";
    ...
    /// <summary>
    /// A Json converter for type <see cref="StatusParam"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class StatusParamJsonConverter : JsonConverter<StatusParam>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override StatusParam Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            StatusParam? result = rawValue == null
                ? null
                : StatusParamValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the StatusParam to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="statusParam"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, StatusParam statusParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(statusParam.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="StatusParam"/>
    /// </summary>
    public class StatusParamNullableJsonConverter : JsonConverter<StatusParam?>
    {
        /// <summary>
        /// Returns a StatusParam from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, StatusParam? statusParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(statusParam?.ToString() ?? "null");
        }
    }
}
