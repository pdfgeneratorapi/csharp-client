...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class CallbackParam : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackParam" /> class.
        /// </summary>
        /// <param name="url">Public callback URL that is used to make a POST request when the document is generated.</param>
        /// <param name="headers">A key-value pairs of header values sent with the POST request.</param>
        [JsonConstructor]
        public CallbackParam(Option<string?> url = default, Option<Object?> headers = default)
        {
            UrlOption = url;
        ...
        /// </summary>
        /// <value>Public callback URL that is used to make a POST request when the document is generated.</value>
        /* <example>https://example.org/document-callback</example> */
        ...
        /// </summary>
        /// <value>A key-value pairs of header values sent with the POST request.</value>
        /* <example>{&quot;Content-type&quot;:&quot;application/json&quot;,&quot;Custom-header&quot;:&quot;ABCDE12345678&quot;}</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="CallbackParam" />
    /// </summary>
    public class CallbackParamJsonConverter : JsonConverter<CallbackParam>
    {
        /// <summary>
        /// Deserializes json to <see cref="CallbackParam" />
        /// </summary>
        ...
        public override CallbackParam Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class CallbackParam.");

            if (headers.IsSet && headers.Value == null)
                throw new ArgumentNullException(nameof(headers), "Property is not nullable for class CallbackParam.");

            return new CallbackParam(url, headers);
        }

        /// <summary>
        /// Serializes a <see cref="CallbackParam" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="callbackParam"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CallbackParam callbackParam, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, callbackParam, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CallbackParam" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="callbackParam"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CallbackParam callbackParam, JsonSerializerOptions jsonSerializerOptions)
        {
            if (callbackParam.UrlOption.IsSet && callbackParam.Url == null)
                throw new ArgumentNullException(nameof(callbackParam.Url), "Property is required for class CallbackParam.");

            if (callbackParam.HeadersOption.IsSet && callbackParam.Headers == null)
                throw new ArgumentNullException(nameof(callbackParam.Headers), "Property is required for class CallbackParam.");

            if (callbackParam.UrlOption.IsSet)
                writer.WriteString("url", callbackParam.Url);

            if (callbackParam.HeadersOption.IsSet)
            {
                writer.WritePropertyName("headers");
                JsonSerializer.Serialize(writer, callbackParam.Headers, jsonSerializerOptions);
            }
        }
    }
}
