...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class ImportTemplateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportTemplateRequest" /> class.
        /// </summary>
        /// <param name="importTemplateUrl"></param>
        public ImportTemplateRequest(ImportTemplateUrl importTemplateUrl)
        {
        ...
        public ImportTemplateRequest(ImportTemplateBase64 importTemplateBase64)
        {
            ImportTemplateBase64 = importTemplateBase64;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets ImportTemplateUrl
        /// </summary>
        public ImportTemplateUrl? ImportTemplateUrl { get; set; }

        /// <summary>
        /// Gets or Sets ImportTemplateBase64
        /// </summary>
        public ImportTemplateBase64? ImportTemplateBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportTemplateRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ImportTemplateRequest" />
    /// </summary>
    public class ImportTemplateRequestJsonConverter : JsonConverter<ImportTemplateRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="ImportTemplateRequest" />
        /// </summary>
        ...
        public override ImportTemplateRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            ImportTemplateUrl? importTemplateUrl = default;
            ImportTemplateBase64? importTemplateBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderImportTemplateUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<ImportTemplateUrl?>(ref utf8JsonReaderImportTemplateUrl, jsonSerializerOptions, out importTemplateUrl);

                    Utf8JsonReader utf8JsonReaderImportTemplateBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<ImportTemplateBase64?>(ref utf8JsonReaderImportTemplateBase64, jsonSerializerOptions, out importTemplateBase64);
                }
            }
            ...
            if (importTemplateUrl != null)
                return new ImportTemplateRequest(importTemplateUrl);

            if (importTemplateBase64 != null)
                return new ImportTemplateRequest(importTemplateBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="ImportTemplateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importTemplateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImportTemplateRequest importTemplateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, importTemplateRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImportTemplateRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importTemplateRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImportTemplateRequest importTemplateRequest, JsonSerializerOptions jsonSerializerOptions)
        {
