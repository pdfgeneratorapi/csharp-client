...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class OptimizeDocumentRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizeDocumentRequest" /> class.
        /// </summary>
        /// <param name="optimizeUrl"></param>
        public OptimizeDocumentRequest(OptimizeUrl optimizeUrl)
        {
        ...
        public OptimizeDocumentRequest(OptimizeBase64 optimizeBase64)
        {
            OptimizeBase64 = optimizeBase64;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets OptimizeUrl
        /// </summary>
        public OptimizeUrl? OptimizeUrl { get; set; }

        /// <summary>
        /// Gets or Sets OptimizeBase64
        /// </summary>
        public OptimizeBase64? OptimizeBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptimizeDocumentRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="OptimizeDocumentRequest" />
    /// </summary>
    public class OptimizeDocumentRequestJsonConverter : JsonConverter<OptimizeDocumentRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="OptimizeDocumentRequest" />
        /// </summary>
        ...
        public override OptimizeDocumentRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            OptimizeUrl? optimizeUrl = default;
            OptimizeBase64? optimizeBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderOptimizeUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<OptimizeUrl?>(ref utf8JsonReaderOptimizeUrl, jsonSerializerOptions, out optimizeUrl);

                    Utf8JsonReader utf8JsonReaderOptimizeBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<OptimizeBase64?>(ref utf8JsonReaderOptimizeBase64, jsonSerializerOptions, out optimizeBase64);
                }
            }
            ...
            if (optimizeUrl != null)
                return new OptimizeDocumentRequest(optimizeUrl);

            if (optimizeBase64 != null)
                return new OptimizeDocumentRequest(optimizeBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="OptimizeDocumentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="optimizeDocumentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OptimizeDocumentRequest optimizeDocumentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, optimizeDocumentRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OptimizeDocumentRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="optimizeDocumentRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OptimizeDocumentRequest optimizeDocumentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
