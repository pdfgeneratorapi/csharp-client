...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject18Meta
    /// </summary>
    public partial class InlineObject18Meta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject18Meta" /> class.
        /// </summary>
        /// <param name="publicId">Form sharing unique identifier</param>
        [JsonConstructor]
        public InlineObject18Meta(Option<string?> publicId = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObject18Meta {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject18Meta" />
    /// </summary>
    public class InlineObject18MetaJsonConverter : JsonConverter<InlineObject18Meta>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject18Meta" />
        /// </summary>
        ...
        public override InlineObject18Meta Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (publicId.IsSet && publicId.Value == null)
                throw new ArgumentNullException(nameof(publicId), "Property is not nullable for class InlineObject18Meta.");

            return new InlineObject18Meta(publicId);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject18Meta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject18Meta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject18Meta inlineObject18Meta, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject18Meta, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject18Meta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject18Meta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject18Meta inlineObject18Meta, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject18Meta.PublicIdOption.IsSet && inlineObject18Meta.PublicId == null)
                throw new ArgumentNullException(nameof(inlineObject18Meta.PublicId), "Property is required for class InlineObject18Meta.");

            if (inlineObject18Meta.PublicIdOption.IsSet)
                writer.WriteString("public_id", inlineObject18Meta.PublicId);
        }
    }
}
