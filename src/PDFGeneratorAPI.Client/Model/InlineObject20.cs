...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject20 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject20(Option<InlineObject20Response?> response = default)
        {
        ...
        public Option<InlineObject20Response?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public InlineObject20Response? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject20JsonConverter : JsonConverter<InlineObject20>
    {
        ...
        public override InlineObject20 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject20Response?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<InlineObject20Response?>(JsonSerializer.Deserialize<InlineObject20Response>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            return new InlineObject20(response);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, InlineObject20 inlineObject20, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (inlineObject20.ResponseOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, inlineObject20.Response, jsonSerializerOptions);
            }
        }
    }
}
