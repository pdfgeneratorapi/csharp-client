...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject20
    /// </summary>
    public partial class InlineObject20 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject20(Option<string?> response = default, Option<InlineObject20Meta?> meta = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObject20Meta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObject20Meta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject20" />
    /// </summary>
    public class InlineObject20JsonConverter : JsonConverter<InlineObject20>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject20" />
        /// </summary>
        ...
        public override InlineObject20 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject20Meta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObject20Meta?>(JsonSerializer.Deserialize<InlineObject20Meta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject20.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject20.");

            return new InlineObject20(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject20" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject20"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject20 inlineObject20, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject20, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject20" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject20"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject20 inlineObject20, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject20.ResponseOption.IsSet && inlineObject20.Response == null)
                throw new ArgumentNullException(nameof(inlineObject20.Response), "Property is required for class InlineObject20.");

            if (inlineObject20.MetaOption.IsSet && inlineObject20.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject20.Meta), "Property is required for class InlineObject20.");

            if (inlineObject20.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject20.Response);

            if (inlineObject20.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject20.Meta, jsonSerializerOptions);
            }
        }
    }
}
