...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject8 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject8(Option<Workspace?> response = default)
        {
        ...
        public Option<Workspace?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public Workspace? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject8" />
    /// </summary>
    public class InlineObject8JsonConverter : JsonConverter<InlineObject8>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject8" />
        /// </summary>
        ...
        public override InlineObject8 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Workspace?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<Workspace?>(JsonSerializer.Deserialize<Workspace>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject8.");

            return new InlineObject8(response);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject8" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject8"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject8 inlineObject8, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject8, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject8" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject8"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject8 inlineObject8, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject8.ResponseOption.IsSet && inlineObject8.Response == null)
                throw new ArgumentNullException(nameof(inlineObject8.Response), "Property is required for class InlineObject8.");

            if (inlineObject8.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject8.Response, jsonSerializerOptions);
            }
        }
    }
}
