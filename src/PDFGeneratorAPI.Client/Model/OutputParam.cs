...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    /// <value>Response format. When the \&quot;file\&quot; option is used the API returns the file inline. With the \&quot;url\&quot; and \&quot;viewer\&quot; option, the document is stored for 30 days and automatically deleted.</value>
    ...
    /// <summary>
    /// Converts <see cref="OutputParam"/> to and from the JSON value
    /// </summary>
    public static class OutputParamValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="OutputParam"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static OutputParam FromString(string value)
        {
            if (value.Equals("base64"))
                return OutputParam.Base64;

            if (value.Equals("url"))
                return OutputParam.Url;

            if (value.Equals("file"))
                return OutputParam.File;

            if (value.Equals("viewer"))
                return OutputParam.Viewer;

            throw new NotImplementedException($"Could not convert value to type OutputParam: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static OutputParam? FromStringOrDefault(string value)
        {
            if (value.Equals("base64"))
                return OutputParam.Base64;
        ...
        /// <summary>
        /// Converts the <see cref="OutputParam"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(OutputParam value)
        {
            if (value == OutputParam.Base64)
                return "base64";

            if (value == OutputParam.Url)
                return "url";

            if (value == OutputParam.File)
                return "file";

            if (value == OutputParam.Viewer)
                return "viewer";
    ...
    /// <summary>
    /// A Json converter for type <see cref="OutputParam"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class OutputParamJsonConverter : JsonConverter<OutputParam>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override OutputParam Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            OutputParam? result = rawValue == null
                ? null
                : OutputParamValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the OutputParam to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="outputParam"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, OutputParam outputParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(outputParam.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="OutputParam"/>
    /// </summary>
    public class OutputParamNullableJsonConverter : JsonConverter<OutputParam?>
    {
        /// <summary>
        /// Returns a OutputParam from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, OutputParam? outputParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(outputParam?.ToString() ?? "null");
        }
    }
}
