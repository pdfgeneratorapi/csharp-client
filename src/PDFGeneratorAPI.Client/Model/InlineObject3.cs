...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject3 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject3(Option<string?> response = default)
        {
        ...
        /// </summary>
        /* <example>https://us1.pdfgeneratorapi.com/editor/open/2ff98760d39456c4b2cf974fef005ecf</example> */
    ...
    public class InlineObject3JsonConverter : JsonConverter<InlineObject3>
    {
        ...
        public override InlineObject3 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject3.");

            return new InlineObject3(response);
        }
        ...
        {
            if (inlineObject3.ResponseOption.IsSet && inlineObject3.Response == null)
                throw new ArgumentNullException(nameof(inlineObject3.Response), "Property is required for class InlineObject3.");

            if (inlineObject3.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject3.Response);
        }
    }
}
