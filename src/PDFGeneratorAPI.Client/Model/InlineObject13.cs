...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject13 : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="jobId">UUID of the async job.</param>
        /// <param name="status">Status of the async job.</param>
        [JsonConstructor]
        public InlineObject13(Option<string?> jobId = default, Option<StatusEnum?> status = default)
        {
            JobIdOption = jobId;
            StatusOption = status;
            OnCreated();
        ...
        /// </summary>
        /// <value>Status of the async job.</value>
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum WebhookError for value: webhook_error
            /// </summary>
            WebhookError = 5
        }
        ...
        public static StatusEnum StatusEnumFromString(string value)
        {
            ...
            if (value.Equals("webhook_error"))
                return StatusEnum.WebhookError;
        ...
        public static string StatusEnumToJsonValue(StatusEnum? value)
        {
            ...
            if (value == StatusEnum.WebhookError)
        ...
        /// </summary>
        /// <value>UUID of the async job.</value>
        /* <example>968b8a3a-e8ac-49cc-a670-25db545813ed</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject13" />
    /// </summary>
    public class InlineObject13JsonConverter : JsonConverter<InlineObject13>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject13" />
        /// </summary>
        ...
        public override InlineObject13 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject13.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<InlineObject13.StatusEnum?>(InlineObject13.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (jobId.IsSet && jobId.Value == null)
                throw new ArgumentNullException(nameof(jobId), "Property is not nullable for class InlineObject13.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class InlineObject13.");

            return new InlineObject13(jobId, status);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject13" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject13"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject13 inlineObject13, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject13, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject13" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject13"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject13 inlineObject13, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject13.JobIdOption.IsSet && inlineObject13.JobId == null)
                throw new ArgumentNullException(nameof(inlineObject13.JobId), "Property is required for class InlineObject13.");

            if (inlineObject13.JobIdOption.IsSet)
                writer.WriteString("job_id", inlineObject13.JobId);

            var statusRawValue = InlineObject13.StatusEnumToJsonValue(inlineObject13.StatusOption.Value!.Value);
