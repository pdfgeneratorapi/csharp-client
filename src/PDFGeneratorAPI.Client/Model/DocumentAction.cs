...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// DocumentAction
    /// </summary>
    public partial class DocumentAction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentAction" /> class.
        /// </summary>
        /// <param name="action">The action performed on the document.</param>
        /// <param name="person">person</param>
        /// <param name="createdAt">Action timestamp (Y-m-d H:i:s).</param>
        [JsonConstructor]
        public DocumentAction(Option<ActionEnum?> action = default, Option<DocumentUser?> person = default, Option<string?> createdAt = default)
        {
            ActionOption = action;
            PersonOption = person;
        ...
        /// </summary>
        /// <value>The action performed on the document.</value>
        public enum ActionEnum
        {
            ...
            /// <summary>
            /// Enum Commented for value: commented
            /// </summary>
            Commented = 5,
        ...
        {
            if (value == ActionEnum.Opened)
                return "opened";

            if (value == ActionEnum.Reviewed)
                return "reviewed";

            if (value == ActionEnum.Accepted)
                return "accepted";

            if (value == ActionEnum.Declined)
                return "declined";

            if (value == ActionEnum.Commented)
                return "commented";

            if (value == ActionEnum.Signed)
                return "signed";

            if (value == ActionEnum.Acknowledged)
                return "acknowledged";
        ...
        /// </summary>
        /// <value>The action performed on the document.</value>
        /* <example>signed</example> */
        [JsonPropertyName("action")]
        public ActionEnum? Action { get { return this.ActionOption; } set { this.ActionOption = new(value); } }

        /// <summary>
        /// Used to track the state of Person
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DocumentUser?> PersonOption { get; private set; }

        /// <summary>
        /// Gets or Sets Person
        /// </summary>
        [JsonPropertyName("person")]
        public DocumentUser? Person { get { return this.PersonOption; } set { this.PersonOption = new(value); } }
        ...
        /// </summary>
        /// <value>Action timestamp (Y-m-d H:i:s).</value>
        /* <example>2026-06-01 10:03:11</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DocumentAction" />
    /// </summary>
    public class DocumentActionJsonConverter : JsonConverter<DocumentAction>
    {
        /// <summary>
        /// Deserializes json to <see cref="DocumentAction" />
        /// </summary>
        ...
        public override DocumentAction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DocumentAction.ActionEnum?> action = default;
            Option<DocumentUser?> person = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "action":
                            ...
                            if (actionRawValue != null)
                                action = new Option<DocumentAction.ActionEnum?>(DocumentAction.ActionEnumFromStringOrDefault(actionRawValue));
                            break;
                        case "person":
                            person = new Option<DocumentUser?>(JsonSerializer.Deserialize<DocumentUser>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "created_at":
            ...
            if (action.IsSet && action.Value == null)
                throw new ArgumentNullException(nameof(action), "Property is not nullable for class DocumentAction.");

            if (person.IsSet && person.Value == null)
                throw new ArgumentNullException(nameof(person), "Property is not nullable for class DocumentAction.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class DocumentAction.");

            return new DocumentAction(action, person, createdAt);
        }

        /// <summary>
        /// Serializes a <see cref="DocumentAction" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="documentAction"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DocumentAction documentAction, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, documentAction, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DocumentAction" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="documentAction"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DocumentAction documentAction, JsonSerializerOptions jsonSerializerOptions)
        {
            if (documentAction.PersonOption.IsSet && documentAction.Person == null)
                throw new ArgumentNullException(nameof(documentAction.Person), "Property is required for class DocumentAction.");

            if (documentAction.CreatedAtOption.IsSet && documentAction.CreatedAt == null)
                throw new ArgumentNullException(nameof(documentAction.CreatedAt), "Property is required for class DocumentAction.");

            var actionRawValue = DocumentAction.ActionEnumToJsonValue(documentAction.ActionOption.Value!.Value);
            writer.WriteString("action", actionRawValue);
            if (documentAction.PersonOption.IsSet)
            {
                writer.WritePropertyName("person");
                JsonSerializer.Serialize(writer, documentAction.Person, jsonSerializerOptions);
            }
            if (documentAction.CreatedAtOption.IsSet)
                writer.WriteString("created_at", documentAction.CreatedAt);
        }
    }
}
