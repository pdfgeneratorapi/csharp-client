...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateDefinitionNewEditor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinitionNewEditor" /> class.
        /// </summary>
        /// <param name="heightMultiplier">heightMultiplier</param>
        [JsonConstructor]
        public TemplateDefinitionNewEditor(Option<decimal?> heightMultiplier = default)
        {
            HeightMultiplierOption = heightMultiplier;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of HeightMultiplier
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<decimal?> HeightMultiplierOption { get; private set; }

        /// <summary>
        /// Gets or Sets HeightMultiplier
        /// </summary>
        /* <example>1</example> */
        [JsonPropertyName("heightMultiplier")]
        public decimal? HeightMultiplier { get { return this.HeightMultiplierOption; } set { this.HeightMultiplierOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HeightMultiplier: ").Append(HeightMultiplier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateDefinitionNewEditor" />
    /// </summary>
    public class TemplateDefinitionNewEditorJsonConverter : JsonConverter<TemplateDefinitionNewEditor>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateDefinitionNewEditor" />
        /// </summary>
        ...
        public override TemplateDefinitionNewEditor Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<decimal?> heightMultiplier = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "heightMultiplier":
                            heightMultiplier = new Option<decimal?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (decimal?)null : utf8JsonReader.GetDecimal());
                            break;
                        default:
                            break;
                    }
            ...
            if (heightMultiplier.IsSet && heightMultiplier.Value == null)
                throw new ArgumentNullException(nameof(heightMultiplier), "Property is not nullable for class TemplateDefinitionNewEditor.");

            return new TemplateDefinitionNewEditor(heightMultiplier);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateDefinitionNewEditor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewEditor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateDefinitionNewEditor templateDefinitionNewEditor, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateDefinitionNewEditor, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateDefinitionNewEditor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewEditor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateDefinitionNewEditor templateDefinitionNewEditor, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateDefinitionNewEditor.HeightMultiplierOption.IsSet)
                writer.WriteNumber("heightMultiplier", templateDefinitionNewEditor.HeightMultiplierOption.Value!.Value);
        }
    }
}
