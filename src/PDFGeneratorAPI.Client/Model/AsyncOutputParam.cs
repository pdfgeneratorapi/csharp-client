...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    /// <value>The generated document is returned as base64 string or URL which is stored for 30 days and automatically deleted.</value>
    public enum AsyncOutputParam
    {
        /// <summary>
    ...
    /// <summary>
    /// Converts <see cref="AsyncOutputParam"/> to and from the JSON value
    /// </summary>
    public static class AsyncOutputParamValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="AsyncOutputParam"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static AsyncOutputParam FromString(string value)
        {
            if (value.Equals("base64"))
                return AsyncOutputParam.Base64;

            if (value.Equals("url"))
                return AsyncOutputParam.Url;

            if (value.Equals("viewer"))
                return AsyncOutputParam.Viewer;

            throw new NotImplementedException($"Could not convert value to type AsyncOutputParam: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static AsyncOutputParam? FromStringOrDefault(string value)
        {
            if (value.Equals("base64"))
                return AsyncOutputParam.Base64;
        ...
        /// <summary>
        /// Converts the <see cref="AsyncOutputParam"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(AsyncOutputParam value)
        {
            if (value == AsyncOutputParam.Base64)
                return "base64";

            if (value == AsyncOutputParam.Url)
                return "url";

            if (value == AsyncOutputParam.Viewer)
                return "viewer";
    ...
    /// <summary>
    /// A Json converter for type <see cref="AsyncOutputParam"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class AsyncOutputParamJsonConverter : JsonConverter<AsyncOutputParam>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override AsyncOutputParam Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            AsyncOutputParam? result = rawValue == null
                ? null
                : AsyncOutputParamValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the AsyncOutputParam to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="asyncOutputParam"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, AsyncOutputParam asyncOutputParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(asyncOutputParam.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="AsyncOutputParam"/>
    /// </summary>
    public class AsyncOutputParamNullableJsonConverter : JsonConverter<AsyncOutputParam?>
    {
        /// <summary>
        /// Returns a AsyncOutputParam from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, AsyncOutputParam? asyncOutputParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(asyncOutputParam?.ToString() ?? "null");
        }
    }
}
