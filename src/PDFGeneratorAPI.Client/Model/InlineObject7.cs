...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject7
    /// </summary>
    public partial class InlineObject7 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject7(Option<InlineObject7Response?> response = default)
        {
        ...
        public Option<InlineObject7Response?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public InlineObject7Response? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject7" />
    /// </summary>
    public class InlineObject7JsonConverter : JsonConverter<InlineObject7>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject7" />
        /// </summary>
        ...
        public override InlineObject7 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject7Response?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<InlineObject7Response?>(JsonSerializer.Deserialize<InlineObject7Response>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject7.");

            return new InlineObject7(response);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject7" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject7"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject7 inlineObject7, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject7, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject7" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject7"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject7 inlineObject7, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject7.ResponseOption.IsSet && inlineObject7.Response == null)
                throw new ArgumentNullException(nameof(inlineObject7.Response), "Property is required for class InlineObject7.");

            if (inlineObject7.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject7.Response, jsonSerializerOptions);
            }
        }
    }
}
