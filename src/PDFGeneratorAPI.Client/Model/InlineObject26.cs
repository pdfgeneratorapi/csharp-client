...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject26 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject26(Option<string?> message = default)
        {
        ...
        /* <example>You can make up to 2 requests per second and 60 requests per minute.</example> */
    ...
    public class InlineObject26JsonConverter : JsonConverter<InlineObject26>
    {
        ...
        {
            if (inlineObject26.MessageOption.IsSet && inlineObject26.Message == null)
                throw new ArgumentNullException(nameof(inlineObject26.Message), "Property is required for class InlineObject26.");

            if (inlineObject26.MessageOption.IsSet)
                writer.WriteString("message", inlineObject26.Message);
        }
    }
}
