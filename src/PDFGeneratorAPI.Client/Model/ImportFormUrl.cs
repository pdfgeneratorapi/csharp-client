...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// ImportFormUrl
    /// </summary>
    public partial class ImportFormUrl : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportFormUrl" /> class.
        /// </summary>
        /// <param name="fileUrl">PDF file from remote URL to import</param>
        /// <param name="form">form</param>
        [JsonConstructor]
        public ImportFormUrl(string fileUrl, Option<FormConfigurationNew?> form = default)
        {
            FileUrl = fileUrl;
            FormOption = form;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ImportFormUrl" />
    /// </summary>
    public class ImportFormUrlJsonConverter : JsonConverter<ImportFormUrl>
    {
        /// <summary>
        /// Deserializes json to <see cref="ImportFormUrl" />
        /// </summary>
        ...
        public override ImportFormUrl Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!fileUrl.IsSet)
                throw new ArgumentException("Property is required for class ImportFormUrl.", nameof(fileUrl));

            if (fileUrl.IsSet && fileUrl.Value == null)
                throw new ArgumentNullException(nameof(fileUrl), "Property is not nullable for class ImportFormUrl.");

            if (form.IsSet && form.Value == null)
                throw new ArgumentNullException(nameof(form), "Property is not nullable for class ImportFormUrl.");

            return new ImportFormUrl(fileUrl.Value!, form);
        }

        /// <summary>
        /// Serializes a <see cref="ImportFormUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importFormUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImportFormUrl importFormUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, importFormUrl, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImportFormUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importFormUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImportFormUrl importFormUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            if (importFormUrl.FileUrl == null)
                throw new ArgumentNullException(nameof(importFormUrl.FileUrl), "Property is required for class ImportFormUrl.");

            if (importFormUrl.FormOption.IsSet && importFormUrl.Form == null)
                throw new ArgumentNullException(nameof(importFormUrl.Form), "Property is required for class ImportFormUrl.");

            writer.WriteString("file_url", importFormUrl.FileUrl);

            if (importFormUrl.FormOption.IsSet)
            {
                writer.WritePropertyName("form");
                JsonSerializer.Serialize(writer, importFormUrl.Form, jsonSerializerOptions);
            }
        }
    }
}
