...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">Base64 encoded XML document if the output&#x3D;base64 is used.</param>
        /// <param name="meta">meta</param>
        [JsonConstructor]
        public InlineObject(Option<string?> response = default, Option<InlineObjectMeta?> meta = default)
        {
        ...
        /// </summary>
        /// <value>Base64 encoded XML document if the output&#x3D;base64 is used.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObjectMeta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObjectMeta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    public class InlineObjectJsonConverter : JsonConverter<InlineObject>
    {
        ...
        public override InlineObject Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObjectMeta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObjectMeta?>(JsonSerializer.Deserialize<InlineObjectMeta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject.");

            return new InlineObject(response, meta);
        }
        ...
        {
            if (inlineObject.ResponseOption.IsSet && inlineObject.Response == null)
                throw new ArgumentNullException(nameof(inlineObject.Response), "Property is required for class InlineObject.");

            if (inlineObject.MetaOption.IsSet && inlineObject.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject.Meta), "Property is required for class InlineObject.");

            if (inlineObject.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject.Response);

            if (inlineObject.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject.Meta, jsonSerializerOptions);
            }
        }
    }
}
