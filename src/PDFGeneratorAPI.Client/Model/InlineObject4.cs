...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject4 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject4(Option<List<Template>?> response = default, Option<PaginationMeta?> meta = default)
        {
        ...
        public Option<List<Template>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<Template>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject4JsonConverter : JsonConverter<InlineObject4>
    {
        ...
        public override InlineObject4 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Template>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<Template>?>(JsonSerializer.Deserialize<List<Template>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject4.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject4.");

            return new InlineObject4(response, meta);
        }
        ...
        {
            if (inlineObject4.ResponseOption.IsSet && inlineObject4.Response == null)
                throw new ArgumentNullException(nameof(inlineObject4.Response), "Property is required for class InlineObject4.");

            if (inlineObject4.MetaOption.IsSet && inlineObject4.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject4.Meta), "Property is required for class InlineObject4.");

            if (inlineObject4.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject4.Response, jsonSerializerOptions);
            }
            if (inlineObject4.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject4.Meta, jsonSerializerOptions);
            }
        }
    }
}
