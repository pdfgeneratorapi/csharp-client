...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class CreateWorkspaceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWorkspaceRequest" /> class.
        /// </summary>
        /// <param name="identifier">A unique identifier of the workspace. Make sure that you can generate the same identifier for your user.</param>
        [JsonConstructor]
        public CreateWorkspaceRequest(Option<string?> identifier = default)
        {
        ...
        /// </summary>
        /// <value>A unique identifier of the workspace. Make sure that you can generate the same identifier for your user.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateWorkspaceRequest" />
    /// </summary>
    public class CreateWorkspaceRequestJsonConverter : JsonConverter<CreateWorkspaceRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateWorkspaceRequest" />
        /// </summary>
        ...
        public override CreateWorkspaceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (identifier.IsSet && identifier.Value == null)
                throw new ArgumentNullException(nameof(identifier), "Property is not nullable for class CreateWorkspaceRequest.");

            return new CreateWorkspaceRequest(identifier);
        }

        /// <summary>
        /// Serializes a <see cref="CreateWorkspaceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createWorkspaceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateWorkspaceRequest createWorkspaceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createWorkspaceRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateWorkspaceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createWorkspaceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateWorkspaceRequest createWorkspaceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createWorkspaceRequest.IdentifierOption.IsSet && createWorkspaceRequest.Identifier == null)
                throw new ArgumentNullException(nameof(createWorkspaceRequest.Identifier), "Property is required for class CreateWorkspaceRequest.");

            if (createWorkspaceRequest.IdentifierOption.IsSet)
                writer.WriteString("identifier", createWorkspaceRequest.Identifier);
        }
    }
}
