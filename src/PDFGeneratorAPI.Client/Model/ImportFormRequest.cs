...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// ImportFormRequest
    /// </summary>
    public partial class ImportFormRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportFormRequest" /> class.
        /// </summary>
        /// <param name="importFormUrl"></param>
        public ImportFormRequest(ImportFormUrl importFormUrl)
        {
        ...
        public ImportFormRequest(ImportFormBase64 importFormBase64)
        {
            ImportFormBase64 = importFormBase64;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets ImportFormUrl
        /// </summary>
        public ImportFormUrl? ImportFormUrl { get; set; }

        /// <summary>
        /// Gets or Sets ImportFormBase64
        /// </summary>
        public ImportFormBase64? ImportFormBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportFormRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ImportFormRequest" />
    /// </summary>
    public class ImportFormRequestJsonConverter : JsonConverter<ImportFormRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="ImportFormRequest" />
        /// </summary>
        ...
        public override ImportFormRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            ImportFormUrl? importFormUrl = default;
            ImportFormBase64? importFormBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderImportFormUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<ImportFormUrl?>(ref utf8JsonReaderImportFormUrl, jsonSerializerOptions, out importFormUrl);

                    Utf8JsonReader utf8JsonReaderImportFormBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<ImportFormBase64?>(ref utf8JsonReaderImportFormBase64, jsonSerializerOptions, out importFormBase64);
                }
            }
            ...
            if (importFormUrl != null)
                return new ImportFormRequest(importFormUrl);

            if (importFormBase64 != null)
                return new ImportFormRequest(importFormBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="ImportFormRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importFormRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImportFormRequest importFormRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, importFormRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImportFormRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importFormRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImportFormRequest importFormRequest, JsonSerializerOptions jsonSerializerOptions)
        {
