...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// FormFieldsUrl
    /// </summary>
    public partial class FormFieldsUrl : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFieldsUrl" /> class.
        /// </summary>
        /// <param name="fileUrl">Public URL to a PDF document</param>
        /// <param name="keyField">keyField</param>
        [JsonConstructor]
        public FormFieldsUrl(string fileUrl, Option<KeyFieldParam?> keyField = default)
        {
            FileUrl = fileUrl;
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormFieldsUrl" />
    /// </summary>
    public class FormFieldsUrlJsonConverter : JsonConverter<FormFieldsUrl>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormFieldsUrl" />
        /// </summary>
        ...
        public override FormFieldsUrl Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!fileUrl.IsSet)
                throw new ArgumentException("Property is required for class FormFieldsUrl.", nameof(fileUrl));

            if (fileUrl.IsSet && fileUrl.Value == null)
                throw new ArgumentNullException(nameof(fileUrl), "Property is not nullable for class FormFieldsUrl.");

            if (keyField.IsSet && keyField.Value == null)
                throw new ArgumentNullException(nameof(keyField), "Property is not nullable for class FormFieldsUrl.");

            return new FormFieldsUrl(fileUrl.Value!, keyField);
        }

        /// <summary>
        /// Serializes a <see cref="FormFieldsUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFieldsUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormFieldsUrl formFieldsUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formFieldsUrl, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormFieldsUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFieldsUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormFieldsUrl formFieldsUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formFieldsUrl.FileUrl == null)
                throw new ArgumentNullException(nameof(formFieldsUrl.FileUrl), "Property is required for class FormFieldsUrl.");

            writer.WriteString("file_url", formFieldsUrl.FileUrl);

            if (formFieldsUrl.KeyFieldOption.IsSet)
            {
                var keyFieldRawValue = KeyFieldParamValueConverter.ToJsonValue(formFieldsUrl.KeyField!.Value);
