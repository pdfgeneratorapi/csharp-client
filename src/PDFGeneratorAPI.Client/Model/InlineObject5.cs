...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject5 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject5(Option<List<Workspace>?> response = default, Option<PaginationMeta?> meta = default)
        {
        ...
        public Option<List<Workspace>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<Workspace>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject5JsonConverter : JsonConverter<InlineObject5>
    {
        ...
        public override InlineObject5 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Workspace>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<Workspace>?>(JsonSerializer.Deserialize<List<Workspace>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject5.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject5.");

            return new InlineObject5(response, meta);
        }
        ...
        {
            if (inlineObject5.ResponseOption.IsSet && inlineObject5.Response == null)
                throw new ArgumentNullException(nameof(inlineObject5.Response), "Property is required for class InlineObject5.");

            if (inlineObject5.MetaOption.IsSet && inlineObject5.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject5.Meta), "Property is required for class InlineObject5.");

            if (inlineObject5.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject5.Response, jsonSerializerOptions);
            }
            if (inlineObject5.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject5.Meta, jsonSerializerOptions);
            }
        }
    }
}
