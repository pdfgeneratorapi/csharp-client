...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class GenerateQRCode201ResponseMeta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateQRCode201ResponseMeta" /> class.
        /// </summary>
        /// <param name="encoding">Response encoding</param>
        /// <param name="contentType">Response content type.</param>
        [JsonConstructor]
        public GenerateQRCode201ResponseMeta(Option<string?> encoding = default, Option<string?> contentType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateQRCode201ResponseMeta {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GenerateQRCode201ResponseMeta" />
    /// </summary>
    public class GenerateQRCode201ResponseMetaJsonConverter : JsonConverter<GenerateQRCode201ResponseMeta>
    {
        /// <summary>
        /// Deserializes json to <see cref="GenerateQRCode201ResponseMeta" />
        /// </summary>
        ...
        public override GenerateQRCode201ResponseMeta Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encoding.IsSet && encoding.Value == null)
                throw new ArgumentNullException(nameof(encoding), "Property is not nullable for class GenerateQRCode201ResponseMeta.");

            if (contentType.IsSet && contentType.Value == null)
                throw new ArgumentNullException(nameof(contentType), "Property is not nullable for class GenerateQRCode201ResponseMeta.");

            return new GenerateQRCode201ResponseMeta(encoding, contentType);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateQRCode201ResponseMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateQRCode201ResponseMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateQRCode201ResponseMeta generateQRCode201ResponseMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateQRCode201ResponseMeta, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateQRCode201ResponseMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateQRCode201ResponseMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateQRCode201ResponseMeta generateQRCode201ResponseMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateQRCode201ResponseMeta.EncodingOption.IsSet && generateQRCode201ResponseMeta.Encoding == null)
                throw new ArgumentNullException(nameof(generateQRCode201ResponseMeta.Encoding), "Property is required for class GenerateQRCode201ResponseMeta.");

            if (generateQRCode201ResponseMeta.ContentTypeOption.IsSet && generateQRCode201ResponseMeta.ContentType == null)
                throw new ArgumentNullException(nameof(generateQRCode201ResponseMeta.ContentType), "Property is required for class GenerateQRCode201ResponseMeta.");

            if (generateQRCode201ResponseMeta.EncodingOption.IsSet)
                writer.WriteString("encoding", generateQRCode201ResponseMeta.Encoding);

            if (generateQRCode201ResponseMeta.ContentTypeOption.IsSet)
                writer.WriteString("content-type", generateQRCode201ResponseMeta.ContentType);
        }
    }
}
