...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateDefinitionEditor : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinitionEditor" /> class.
        /// </summary>
        /// <param name="heightMultiplier">heightMultiplier</param>
        [JsonConstructor]
        public TemplateDefinitionEditor(Option<decimal?> heightMultiplier = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateDefinitionEditor {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateDefinitionEditor" />
    /// </summary>
    public class TemplateDefinitionEditorJsonConverter : JsonConverter<TemplateDefinitionEditor>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateDefinitionEditor" />
        /// </summary>
        ...
        public override TemplateDefinitionEditor Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (heightMultiplier.IsSet && heightMultiplier.Value == null)
                throw new ArgumentNullException(nameof(heightMultiplier), "Property is not nullable for class TemplateDefinitionEditor.");

            return new TemplateDefinitionEditor(heightMultiplier);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateDefinitionEditor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionEditor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateDefinitionEditor templateDefinitionEditor, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateDefinitionEditor, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateDefinitionEditor" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionEditor"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateDefinitionEditor templateDefinitionEditor, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateDefinitionEditor.HeightMultiplierOption.IsSet)
                writer.WriteNumber("heightMultiplier", templateDefinitionEditor.HeightMultiplierOption.Value!.Value);
        }
    }
}
