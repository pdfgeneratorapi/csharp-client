...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class InlineObject20Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject20Response" /> class.
        /// </summary>
        /// <param name="jobId">Unique job id which is also added to the callback request as header PDF-API-Job-Id</param>
        [JsonConstructor]
        public InlineObject20Response(Option<string?> jobId = default)
        {
            JobIdOption = jobId;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObject20Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject20Response" />
    /// </summary>
    public class InlineObject20ResponseJsonConverter : JsonConverter<InlineObject20Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject20Response" />
        /// </summary>
        ...
        public override InlineObject20Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (jobId.IsSet && jobId.Value == null)
                throw new ArgumentNullException(nameof(jobId), "Property is not nullable for class InlineObject20Response.");

            return new InlineObject20Response(jobId);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject20Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject20Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject20Response inlineObject20Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject20Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject20Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject20Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject20Response inlineObject20Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject20Response.JobIdOption.IsSet && inlineObject20Response.JobId == null)
                throw new ArgumentNullException(nameof(inlineObject20Response.JobId), "Property is required for class InlineObject20Response.");

            if (inlineObject20Response.JobIdOption.IsSet)
                writer.WriteString("job_id", inlineObject20Response.JobId);
        }
    }
}
