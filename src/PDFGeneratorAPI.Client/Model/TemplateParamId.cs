...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateParamId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateParamId" /> class.
        /// </summary>
        /// <param name="int"></param>
        internal TemplateParamId(int @int)
        {
            Int = @int;
            OnCreated();
        }
        ...
        internal TemplateParamId(string @string)
        {
            String = @string;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateParamId {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateParamId" />
    /// </summary>
    public class TemplateParamIdJsonConverter : JsonConverter<TemplateParamId>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateParamId" />
        /// </summary>
        ...
        public override TemplateParamId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varInt != null)
                return new TemplateParamId(varInt.Value);

            if (varString != null)
                return new TemplateParamId(varString);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="TemplateParamId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateParamId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateParamId templateParamId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateParamId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateParamId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateParamId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateParamId templateParamId, JsonSerializerOptions jsonSerializerOptions)
        {
