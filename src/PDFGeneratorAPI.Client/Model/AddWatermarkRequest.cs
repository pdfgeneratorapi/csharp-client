...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// AddWatermarkRequest
    /// </summary>
    public partial class AddWatermarkRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddWatermarkRequest" /> class.
        /// </summary>
        /// <param name="watermarkFileUrl"></param>
        public AddWatermarkRequest(WatermarkFileUrl watermarkFileUrl)
        {
        ...
        public AddWatermarkRequest(WatermarkBase64 watermarkBase64)
        {
        ...
        /// <summary>
        /// Gets or Sets WatermarkFileUrl
        /// </summary>
        public WatermarkFileUrl? WatermarkFileUrl { get; set; }

        /// <summary>
        /// Gets or Sets WatermarkBase64
        /// </summary>
        public WatermarkBase64? WatermarkBase64 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddWatermarkRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddWatermarkRequest" />
    /// </summary>
    public class AddWatermarkRequestJsonConverter : JsonConverter<AddWatermarkRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="AddWatermarkRequest" />
        /// </summary>
        ...
        public override AddWatermarkRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WatermarkFileUrl? watermarkFileUrl = default;
            WatermarkBase64? watermarkBase64 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderWatermarkFileUrl = utf8JsonReader;
                    ClientUtils.TryDeserialize<WatermarkFileUrl?>(ref utf8JsonReaderWatermarkFileUrl, jsonSerializerOptions, out watermarkFileUrl);

                    Utf8JsonReader utf8JsonReaderWatermarkBase64 = utf8JsonReader;
                    ClientUtils.TryDeserialize<WatermarkBase64?>(ref utf8JsonReaderWatermarkBase64, jsonSerializerOptions, out watermarkBase64);
                }
            }
            ...
            if (watermarkFileUrl != null)
                return new AddWatermarkRequest(watermarkFileUrl);

            if (watermarkBase64 != null)
                return new AddWatermarkRequest(watermarkBase64);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="AddWatermarkRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addWatermarkRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddWatermarkRequest addWatermarkRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addWatermarkRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddWatermarkRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addWatermarkRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddWatermarkRequest addWatermarkRequest, JsonSerializerOptions jsonSerializerOptions)
        {
