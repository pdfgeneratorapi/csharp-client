...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject19 : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">URL to open the embeddable Form Builder</param>
        [JsonConstructor]
        public InlineObject19(Option<string?> response = default)
        {
        ...
        /// </summary>
        /// <value>URL to open the embeddable Form Builder</value>
        /* <example>https://app.pdfgeneratorapi.com/forms/builder/097475c4-dcd5-42ca-814f-b9fa3da66b5a</example> */
    ...
    public class InlineObject19JsonConverter : JsonConverter<InlineObject19>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, InlineObject19 inlineObject19, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (inlineObject19.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject19.Response);
        }
    }
}
