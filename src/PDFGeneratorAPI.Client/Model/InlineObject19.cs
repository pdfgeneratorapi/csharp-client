...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject19
    /// </summary>
    public partial class InlineObject19 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject19(Option<FormConfiguration?> response = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject19" />
    /// </summary>
    public class InlineObject19JsonConverter : JsonConverter<InlineObject19>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject19" />
        /// </summary>
        ...
        public override InlineObject19 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject19.");

            return new InlineObject19(response);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject19" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject19"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject19 inlineObject19, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject19, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject19" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject19"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject19 inlineObject19, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject19.ResponseOption.IsSet && inlineObject19.Response == null)
                throw new ArgumentNullException(nameof(inlineObject19.Response), "Property is required for class InlineObject19.");

            if (inlineObject19.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject19.Response, jsonSerializerOptions);
            }
        }
    }
}
