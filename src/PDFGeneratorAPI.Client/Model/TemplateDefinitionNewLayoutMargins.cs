...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateDefinitionNewLayoutMargins : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinitionNewLayoutMargins" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public TemplateDefinitionNewLayoutMargins(Option<decimal?> top = default, Option<decimal?> right = default, Option<decimal?> bottom = default, Option<decimal?> left = default)
        {
            TopOption = top;
            RightOption = right;
            BottomOption = bottom;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateDefinitionNewLayoutMargins {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateDefinitionNewLayoutMargins" />
    /// </summary>
    public class TemplateDefinitionNewLayoutMarginsJsonConverter : JsonConverter<TemplateDefinitionNewLayoutMargins>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateDefinitionNewLayoutMargins" />
        /// </summary>
        ...
        public override TemplateDefinitionNewLayoutMargins Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "top":
                            ...
                            break;
                        case "right":
                            right = new Option<decimal?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (decimal?)null : utf8JsonReader.GetDecimal());
                            break;
                        case "bottom":
                            bottom = new Option<decimal?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (decimal?)null : utf8JsonReader.GetDecimal());
                            break;
                        case "left":
            ...
            if (top.IsSet && top.Value == null)
                throw new ArgumentNullException(nameof(top), "Property is not nullable for class TemplateDefinitionNewLayoutMargins.");

            if (right.IsSet && right.Value == null)
                throw new ArgumentNullException(nameof(right), "Property is not nullable for class TemplateDefinitionNewLayoutMargins.");

            if (bottom.IsSet && bottom.Value == null)
                throw new ArgumentNullException(nameof(bottom), "Property is not nullable for class TemplateDefinitionNewLayoutMargins.");

            if (left.IsSet && left.Value == null)
                throw new ArgumentNullException(nameof(left), "Property is not nullable for class TemplateDefinitionNewLayoutMargins.");

            return new TemplateDefinitionNewLayoutMargins(top, right, bottom, left);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateDefinitionNewLayoutMargins" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewLayoutMargins"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateDefinitionNewLayoutMargins templateDefinitionNewLayoutMargins, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateDefinitionNewLayoutMargins, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateDefinitionNewLayoutMargins" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewLayoutMargins"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateDefinitionNewLayoutMargins templateDefinitionNewLayoutMargins, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateDefinitionNewLayoutMargins.TopOption.IsSet)
                writer.WriteNumber("top", templateDefinitionNewLayoutMargins.TopOption.Value!.Value);

            if (templateDefinitionNewLayoutMargins.RightOption.IsSet)
                writer.WriteNumber("right", templateDefinitionNewLayoutMargins.RightOption.Value!.Value);

            if (templateDefinitionNewLayoutMargins.BottomOption.IsSet)
                writer.WriteNumber("bottom", templateDefinitionNewLayoutMargins.BottomOption.Value!.Value);

            if (templateDefinitionNewLayoutMargins.LeftOption.IsSet)
                writer.WriteNumber("left", templateDefinitionNewLayoutMargins.LeftOption.Value!.Value);
        }
    }
}
