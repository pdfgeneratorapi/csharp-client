...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    /// <value>Specifies which field is used to map the extract fields. If your document contains fields with the same name, then we suggest using the id field. Defaults to name.</value>
    public enum KeyFieldParam
    {
        /// <summary>
    ...
    /// <summary>
    /// Converts <see cref="KeyFieldParam"/> to and from the JSON value
    /// </summary>
    public static class KeyFieldParamValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="KeyFieldParam"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static KeyFieldParam FromString(string value)
        {
            if (value.Equals("name"))
                return KeyFieldParam.Name;

            if (value.Equals("id"))
                return KeyFieldParam.Id;

            throw new NotImplementedException($"Could not convert value to type KeyFieldParam: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static KeyFieldParam? FromStringOrDefault(string value)
        {
            if (value.Equals("name"))
                return KeyFieldParam.Name;
        ...
        /// <summary>
        /// Converts the <see cref="KeyFieldParam"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(KeyFieldParam value)
        {
            if (value == KeyFieldParam.Name)
                return "name";

            if (value == KeyFieldParam.Id)
                return "id";
    ...
    /// <summary>
    /// A Json converter for type <see cref="KeyFieldParam"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class KeyFieldParamJsonConverter : JsonConverter<KeyFieldParam>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override KeyFieldParam Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            KeyFieldParam? result = rawValue == null
                ? null
                : KeyFieldParamValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the KeyFieldParam to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="keyFieldParam"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, KeyFieldParam keyFieldParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(keyFieldParam.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="KeyFieldParam"/>
    /// </summary>
    public class KeyFieldParamNullableJsonConverter : JsonConverter<KeyFieldParam?>
    {
        /// <summary>
        /// Returns a KeyFieldParam from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, KeyFieldParam? keyFieldParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(keyFieldParam?.ToString() ?? "null");
        }
    }
}
