...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class OpenEditorRequestData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenEditorRequestData" /> class.
        /// </summary>
        /// <param name="object"></param>
        internal OpenEditorRequestData(Object @object)
        {
            Object = @object;
            OnCreated();
        }
        ...
        internal OpenEditorRequestData(List<Object> list)
        {
            List = list;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>JSON data used to replace data fields in the template</value>
        /* <example>[{&quot;id&quot;:123,&quot;name&quot;:&quot;John Smith&quot;,&quot;birthdate&quot;:&quot;2000-05-12&quot;,&quot;role&quot;:&quot;Developer&quot;},{&quot;id&quot;:123,&quot;name&quot;:&quot;Jane Doe&quot;,&quot;birthdate&quot;:&quot;1999-03-12&quot;,&quot;role&quot;:&quot;Manager&quot;}]</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenEditorRequestData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="OpenEditorRequestData" />
    /// </summary>
    public class OpenEditorRequestDataJsonConverter : JsonConverter<OpenEditorRequestData>
    {
        /// <summary>
        /// Deserializes json to <see cref="OpenEditorRequestData" />
        /// </summary>
        ...
        public override OpenEditorRequestData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varObject != null)
                return new OpenEditorRequestData(varObject);

            if (list != null)
                return new OpenEditorRequestData(list);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="OpenEditorRequestData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="openEditorRequestData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OpenEditorRequestData openEditorRequestData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, openEditorRequestData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OpenEditorRequestData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="openEditorRequestData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OpenEditorRequestData openEditorRequestData, JsonSerializerOptions jsonSerializerOptions)
        {
