...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject17 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject17(Option<FormConfiguration?> response = default)
        {
        ...
        public Option<FormConfiguration?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public FormConfiguration? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject17JsonConverter : JsonConverter<InlineObject17>
    {
        ...
        public override InlineObject17 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<FormConfiguration?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<FormConfiguration?>(JsonSerializer.Deserialize<FormConfiguration>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
