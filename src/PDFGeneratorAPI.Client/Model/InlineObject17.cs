...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject17
    /// </summary>
    public partial class InlineObject17 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject17(Option<List<DocumentAction>?> response = default)
        {
        ...
        public Option<List<DocumentAction>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<DocumentAction>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject17" />
    /// </summary>
    public class InlineObject17JsonConverter : JsonConverter<InlineObject17>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject17" />
        /// </summary>
        ...
        public override InlineObject17 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<DocumentAction>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<DocumentAction>?>(JsonSerializer.Deserialize<List<DocumentAction>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject17.");

            return new InlineObject17(response);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject17" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject17"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject17 inlineObject17, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject17, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject17" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject17"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject17 inlineObject17, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject17.ResponseOption.IsSet && inlineObject17.Response == null)
                throw new ArgumentNullException(nameof(inlineObject17.Response), "Property is required for class InlineObject17.");

            if (inlineObject17.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject17.Response, jsonSerializerOptions);
            }
        }
    }
}
