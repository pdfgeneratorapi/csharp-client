...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// Current field value
    /// </summary>
    public partial class InlineObject14ResponseValueValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObject14ResponseValueValue" /> class.
        /// </summary>
        /// <param name="string"></param>
        internal InlineObject14ResponseValueValue(string @string)
        {
            String = @string;
            OnCreated();
        }
        ...
        internal InlineObject14ResponseValueValue(bool @bool)
        {
            Bool = @bool;
            OnCreated();
        }
        ...
        internal InlineObject14ResponseValueValue(List<string> list)
        {
            List = list;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObject14ResponseValueValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject14ResponseValueValue" />
    /// </summary>
    public class InlineObject14ResponseValueValueJsonConverter : JsonConverter<InlineObject14ResponseValueValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject14ResponseValueValue" />
        /// </summary>
        ...
        public override InlineObject14ResponseValueValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varString != null)
                return new InlineObject14ResponseValueValue(varString);

            if (varBool != null)
                return new InlineObject14ResponseValueValue(varBool.Value);

            if (list != null)
                return new InlineObject14ResponseValueValue(list);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject14ResponseValueValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject14ResponseValueValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject14ResponseValueValue inlineObject14ResponseValueValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject14ResponseValueValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject14ResponseValueValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject14ResponseValueValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject14ResponseValueValue inlineObject14ResponseValueValue, JsonSerializerOptions jsonSerializerOptions)
        {
