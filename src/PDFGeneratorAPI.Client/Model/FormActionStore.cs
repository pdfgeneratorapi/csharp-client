...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class FormActionStore : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormActionStore" /> class.
        /// </summary>
        /// <param name="storeDocument">storeDocument</param>
        [JsonConstructor]
        public FormActionStore(Option<bool?> storeDocument = default)
        {
            StoreDocumentOption = storeDocument;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of StoreDocument
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> StoreDocumentOption { get; private set; }

        /// <summary>
        /// Gets or Sets StoreDocument
        /// </summary>
        /* <example>true</example> */
        [JsonPropertyName("store_document")]
        public bool? StoreDocument { get { return this.StoreDocumentOption; } set { this.StoreDocumentOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormActionStore {\n");
            sb.Append("  StoreDocument: ").Append(StoreDocument).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormActionStore" />
    /// </summary>
    public class FormActionStoreJsonConverter : JsonConverter<FormActionStore>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormActionStore" />
        /// </summary>
        ...
        public override FormActionStore Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<bool?> storeDocument = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "store_document":
                            storeDocument = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (storeDocument.IsSet && storeDocument.Value == null)
                throw new ArgumentNullException(nameof(storeDocument), "Property is not nullable for class FormActionStore.");

            return new FormActionStore(storeDocument);
        }

        /// <summary>
        /// Serializes a <see cref="FormActionStore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formActionStore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormActionStore formActionStore, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formActionStore, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormActionStore" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formActionStore"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormActionStore formActionStore, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formActionStore.StoreDocumentOption.IsSet)
                writer.WriteBoolean("store_document", formActionStore.StoreDocumentOption.Value!.Value);
        }
    }
}
