...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class ImportTemplateUrlTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportTemplateUrlTemplate" /> class.
        /// </summary>
        /// <param name="name">Template name</param>
        [JsonConstructor]
        public ImportTemplateUrlTemplate(string name)
        {
            Name = name;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportTemplateUrlTemplate {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ImportTemplateUrlTemplate" />
    /// </summary>
    public class ImportTemplateUrlTemplateJsonConverter : JsonConverter<ImportTemplateUrlTemplate>
    {
        /// <summary>
        /// Deserializes json to <see cref="ImportTemplateUrlTemplate" />
        /// </summary>
        ...
        public override ImportTemplateUrlTemplate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ImportTemplateUrlTemplate.", nameof(name));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ImportTemplateUrlTemplate.");

            return new ImportTemplateUrlTemplate(name.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ImportTemplateUrlTemplate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importTemplateUrlTemplate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImportTemplateUrlTemplate importTemplateUrlTemplate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, importTemplateUrlTemplate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImportTemplateUrlTemplate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importTemplateUrlTemplate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImportTemplateUrlTemplate importTemplateUrlTemplate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (importTemplateUrlTemplate.Name == null)
                throw new ArgumentNullException(nameof(importTemplateUrlTemplate.Name), "Property is required for class ImportTemplateUrlTemplate.");

            writer.WriteString("name", importTemplateUrlTemplate.Name);
        }
    }
}
