...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class GetTemplateVersion422Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTemplateVersion422Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        [JsonConstructor]
        public GetTemplateVersion422Response(Option<string?> message = default)
        {
        ...
        /// </summary>
        /* <example>Cannot delete production template version.</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTemplateVersion422Response {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetTemplateVersion422Response" />
    /// </summary>
    public class GetTemplateVersion422ResponseJsonConverter : JsonConverter<GetTemplateVersion422Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetTemplateVersion422Response" />
        /// </summary>
        ...
        public override GetTemplateVersion422Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class GetTemplateVersion422Response.");

            return new GetTemplateVersion422Response(message);
        }

        /// <summary>
        /// Serializes a <see cref="GetTemplateVersion422Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getTemplateVersion422Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetTemplateVersion422Response getTemplateVersion422Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getTemplateVersion422Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetTemplateVersion422Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getTemplateVersion422Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetTemplateVersion422Response getTemplateVersion422Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getTemplateVersion422Response.MessageOption.IsSet && getTemplateVersion422Response.Message == null)
                throw new ArgumentNullException(nameof(getTemplateVersion422Response.Message), "Property is required for class GetTemplateVersion422Response.");

            if (getTemplateVersion422Response.MessageOption.IsSet)
                writer.WriteString("message", getTemplateVersion422Response.Message);
        }
    }
}
