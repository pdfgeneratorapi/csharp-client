...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject11 : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">Public URL to the document.</param>
        /// <param name="meta">meta</param>
        [JsonConstructor]
        public InlineObject11(Option<string?> response = default, Option<InlineObject11Meta?> meta = default)
        {
        ...
        /// </summary>
        /// <value>Public URL to the document.</value>
        /* <example>https://us1.pdfgeneratorapi.com/api/v4/documents/66/bac8381bce1982e5f6957a0f52371336/share</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObject11Meta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObject11Meta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject11" />
    /// </summary>
    public class InlineObject11JsonConverter : JsonConverter<InlineObject11>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject11" />
        /// </summary>
        ...
        public override InlineObject11 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject11Meta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObject11Meta?>(JsonSerializer.Deserialize<InlineObject11Meta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject11.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject11.");

            return new InlineObject11(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject11" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject11"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject11 inlineObject11, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject11, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject11" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject11"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject11 inlineObject11, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject11.ResponseOption.IsSet && inlineObject11.Response == null)
                throw new ArgumentNullException(nameof(inlineObject11.Response), "Property is required for class InlineObject11.");

            if (inlineObject11.MetaOption.IsSet && inlineObject11.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject11.Meta), "Property is required for class InlineObject11.");

            if (inlineObject11.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject11.Response);

            if (inlineObject11.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject11.Meta, jsonSerializerOptions);
            }
        }
    }
}
