...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject16 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject16(Option<List<DocumentVersion>?> response = default)
        {
        ...
        public Option<List<DocumentVersion>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<DocumentVersion>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject16JsonConverter : JsonConverter<InlineObject16>
    {
        ...
        public override InlineObject16 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<DocumentVersion>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<DocumentVersion>?>(JsonSerializer.Deserialize<List<DocumentVersion>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            return new InlineObject16(response);
        }
