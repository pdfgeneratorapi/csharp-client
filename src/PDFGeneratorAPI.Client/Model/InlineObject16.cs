...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObject16
    /// </summary>
    public partial class InlineObject16 : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public InlineObject16(Option<TemplateDefinition?> response = default, Option<Object?> meta = default)
        {
        ...
        public Option<TemplateDefinition?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public TemplateDefinition? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject16" />
    /// </summary>
    public class InlineObject16JsonConverter : JsonConverter<InlineObject16>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject16" />
        /// </summary>
        ...
        public override InlineObject16 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TemplateDefinition?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<TemplateDefinition?>(JsonSerializer.Deserialize<TemplateDefinition>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject16.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject16.");

            return new InlineObject16(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject16" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject16"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject16 inlineObject16, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject16, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject16" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject16"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject16 inlineObject16, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject16.ResponseOption.IsSet && inlineObject16.Response == null)
                throw new ArgumentNullException(nameof(inlineObject16.Response), "Property is required for class InlineObject16.");

            if (inlineObject16.MetaOption.IsSet && inlineObject16.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject16.Meta), "Property is required for class InlineObject16.");

            if (inlineObject16.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject16.Response, jsonSerializerOptions);
            }
            if (inlineObject16.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject16.Meta, jsonSerializerOptions);
            }
        }
    }
}
