...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class MetadataParam : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetadataParam" /> class.
        /// </summary>
        /// <param name="author">Document author (default to &quot;Organization name&quot;)</param>
        /// <param name="language">Document language (default to &quot;en&quot;)</param>
        [JsonConstructor]
        public MetadataParam(Option<string?> author = default, Option<string?> language = default)
        {
            AuthorOption = author;
    ...
    /// <summary>
    /// A Json converter for type <see cref="MetadataParam" />
    /// </summary>
    public class MetadataParamJsonConverter : JsonConverter<MetadataParam>
    {
        /// <summary>
        /// Deserializes json to <see cref="MetadataParam" />
        /// </summary>
        ...
        public override MetadataParam Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (author.IsSet && author.Value == null)
                throw new ArgumentNullException(nameof(author), "Property is not nullable for class MetadataParam.");

            if (language.IsSet && language.Value == null)
                throw new ArgumentNullException(nameof(language), "Property is not nullable for class MetadataParam.");

            return new MetadataParam(author, language);
        }

        /// <summary>
        /// Serializes a <see cref="MetadataParam" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="metadataParam"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MetadataParam metadataParam, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, metadataParam, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MetadataParam" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="metadataParam"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MetadataParam metadataParam, JsonSerializerOptions jsonSerializerOptions)
        {
            if (metadataParam.AuthorOption.IsSet && metadataParam.Author == null)
                throw new ArgumentNullException(nameof(metadataParam.Author), "Property is required for class MetadataParam.");

            if (metadataParam.LanguageOption.IsSet && metadataParam.Language == null)
                throw new ArgumentNullException(nameof(metadataParam.Language), "Property is required for class MetadataParam.");

            if (metadataParam.AuthorOption.IsSet)
                writer.WriteString("author", metadataParam.Author);

            if (metadataParam.LanguageOption.IsSet)
                writer.WriteString("language", metadataParam.Language);
        }
    }
}
