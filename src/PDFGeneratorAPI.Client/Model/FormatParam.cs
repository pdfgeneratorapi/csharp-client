...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// <summary>
    /// Converts <see cref="FormatParam"/> to and from the JSON value
    /// </summary>
    public static class FormatParamValueConverter
    {
        /// <summary>
        /// Parses a given value to <see cref="FormatParam"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public static FormatParam FromString(string value)
        {
            if (value.Equals("pdf"))
                return FormatParam.Pdf;

            if (value.Equals("html"))
                return FormatParam.Html;

            throw new NotImplementedException($"Could not convert value to type FormatParam: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static FormatParam? FromStringOrDefault(string value)
        {
            if (value.Equals("pdf"))
                return FormatParam.Pdf;
        ...
        /// <summary>
        /// Converts the <see cref="FormatParam"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ToJsonValue(FormatParam value)
        {
            if (value == FormatParam.Pdf)
                return "pdf";

            if (value == FormatParam.Html)
                return "html";
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormatParam"/>
    /// </summary>
    /// <exception cref="NotImplementedException"></exception>
    public class FormatParamJsonConverter : JsonConverter<FormatParam>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override FormatParam Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            string? rawValue = reader.GetString();

            FormatParam? result = rawValue == null
                ? null
                : FormatParamValueConverter.FromStringOrDefault(rawValue);
        ...
        /// <summary>
        /// Writes the FormatParam to the json writer
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formatParam"></param>
        /// <param name="options"></param>
        public override void Write(Utf8JsonWriter writer, FormatParam formatParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(formatParam.ToString());
        }
    }
    ...
    /// A Json converter for type <see cref="FormatParam"/>
    /// </summary>
    public class FormatParamNullableJsonConverter : JsonConverter<FormatParam?>
    {
        /// <summary>
        /// Returns a FormatParam from the Json object
        /// </summary>
        /// <param name="reader"></param>
        /// <param name="typeToConvert"></param>
        /// <param name="options"></param>
        ...
        public override void Write(Utf8JsonWriter writer, FormatParam? formatParam, JsonSerializerOptions options)
        {
            writer.WriteStringValue(formatParam?.ToString() ?? "null");
        }
    }
}
