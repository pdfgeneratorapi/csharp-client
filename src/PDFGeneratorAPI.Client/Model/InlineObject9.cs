...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject9 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject9(Option<string?> response = default, Option<InlineObject9Meta?> meta = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObject9Meta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObject9Meta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject9" />
    /// </summary>
    public class InlineObject9JsonConverter : JsonConverter<InlineObject9>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject9" />
        /// </summary>
        ...
        public override InlineObject9 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject9Meta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObject9Meta?>(JsonSerializer.Deserialize<InlineObject9Meta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject9.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject9.");

            return new InlineObject9(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject9" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject9"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject9 inlineObject9, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject9, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject9" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject9"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject9 inlineObject9, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject9.ResponseOption.IsSet && inlineObject9.Response == null)
                throw new ArgumentNullException(nameof(inlineObject9.Response), "Property is required for class InlineObject9.");

            if (inlineObject9.MetaOption.IsSet && inlineObject9.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject9.Meta), "Property is required for class InlineObject9.");

            if (inlineObject9.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject9.Response);

            if (inlineObject9.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject9.Meta, jsonSerializerOptions);
            }
        }
    }
}
