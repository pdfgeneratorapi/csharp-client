...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// OptimizeUrl
    /// </summary>
    public partial class OptimizeUrl : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptimizeUrl" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public OptimizeUrl(string fileUrl, Option<string?> name = default, Option<OutputEnum?> output = default)
        {
            FileUrl = fileUrl;
            NameOption = name;
            OutputOption = output;
    ...
    /// <summary>
    /// A Json converter for type <see cref="OptimizeUrl" />
    /// </summary>
    public class OptimizeUrlJsonConverter : JsonConverter<OptimizeUrl>
    {
        /// <summary>
        /// Deserializes json to <see cref="OptimizeUrl" />
        /// </summary>
        ...
        public override OptimizeUrl Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<OptimizeUrl.OutputEnum?> output = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "output":
                            ...
                            if (outputRawValue != null)
                                output = new Option<OptimizeUrl.OutputEnum?>(OptimizeUrl.OutputEnumFromStringOrDefault(outputRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!fileUrl.IsSet)
                throw new ArgumentException("Property is required for class OptimizeUrl.", nameof(fileUrl));

            if (fileUrl.IsSet && fileUrl.Value == null)
                throw new ArgumentNullException(nameof(fileUrl), "Property is not nullable for class OptimizeUrl.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class OptimizeUrl.");

            if (output.IsSet && output.Value == null)
                throw new ArgumentNullException(nameof(output), "Property is not nullable for class OptimizeUrl.");

            return new OptimizeUrl(fileUrl.Value!, name, output);
        }

        /// <summary>
        /// Serializes a <see cref="OptimizeUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="optimizeUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OptimizeUrl optimizeUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, optimizeUrl, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OptimizeUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="optimizeUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OptimizeUrl optimizeUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            if (optimizeUrl.FileUrl == null)
                throw new ArgumentNullException(nameof(optimizeUrl.FileUrl), "Property is required for class OptimizeUrl.");

            if (optimizeUrl.NameOption.IsSet && optimizeUrl.Name == null)
                throw new ArgumentNullException(nameof(optimizeUrl.Name), "Property is required for class OptimizeUrl.");

            writer.WriteString("file_url", optimizeUrl.FileUrl);

            if (optimizeUrl.NameOption.IsSet)
                writer.WriteString("name", optimizeUrl.Name);

            var outputRawValue = OptimizeUrl.OutputEnumToJsonValue(optimizeUrl.OutputOption.Value!.Value);
