...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject2(Option<Object?> response = default)
        {
    ...
    public class InlineObject2JsonConverter : JsonConverter<InlineObject2>
    {
        ...
        public override InlineObject2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject2.");

            return new InlineObject2(response);
        }
        ...
        {
            if (inlineObject2.ResponseOption.IsSet && inlineObject2.Response == null)
                throw new ArgumentNullException(nameof(inlineObject2.Response), "Property is required for class InlineObject2.");

            if (inlineObject2.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject2.Response, jsonSerializerOptions);
            }
        }
    }
}
