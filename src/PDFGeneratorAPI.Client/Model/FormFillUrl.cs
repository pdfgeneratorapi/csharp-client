...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// FormFillUrl
    /// </summary>
    public partial class FormFillUrl : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFillUrl" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public FormFillUrl(string fileUrl, Object data, Option<OutputEnum?> output = default, Option<string?> name = default)
        {
            FileUrl = fileUrl;
            Data = data;
            OutputOption = output;
    ...
    /// <summary>
    /// A Json converter for type <see cref="FormFillUrl" />
    /// </summary>
    public class FormFillUrlJsonConverter : JsonConverter<FormFillUrl>
    {
        /// <summary>
        /// Deserializes json to <see cref="FormFillUrl" />
        /// </summary>
        ...
        public override FormFillUrl Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<FormFillUrl.OutputEnum?> output = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "output":
                            ...
                            if (outputRawValue != null)
                                output = new Option<FormFillUrl.OutputEnum?>(FormFillUrl.OutputEnumFromStringOrDefault(outputRawValue));
                            break;
                        case "name":
            ...
            if (!fileUrl.IsSet)
                throw new ArgumentException("Property is required for class FormFillUrl.", nameof(fileUrl));

            if (!data.IsSet)
                throw new ArgumentException("Property is required for class FormFillUrl.", nameof(data));

            if (fileUrl.IsSet && fileUrl.Value == null)
                throw new ArgumentNullException(nameof(fileUrl), "Property is not nullable for class FormFillUrl.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class FormFillUrl.");

            if (output.IsSet && output.Value == null)
                throw new ArgumentNullException(nameof(output), "Property is not nullable for class FormFillUrl.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class FormFillUrl.");

            return new FormFillUrl(fileUrl.Value!, data.Value!, output, name);
        }

        /// <summary>
        /// Serializes a <see cref="FormFillUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFillUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FormFillUrl formFillUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, formFillUrl, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FormFillUrl" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="formFillUrl"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FormFillUrl formFillUrl, JsonSerializerOptions jsonSerializerOptions)
        {
            if (formFillUrl.FileUrl == null)
                throw new ArgumentNullException(nameof(formFillUrl.FileUrl), "Property is required for class FormFillUrl.");

            if (formFillUrl.Data == null)
                throw new ArgumentNullException(nameof(formFillUrl.Data), "Property is required for class FormFillUrl.");

            if (formFillUrl.NameOption.IsSet && formFillUrl.Name == null)
                throw new ArgumentNullException(nameof(formFillUrl.Name), "Property is required for class FormFillUrl.");

            writer.WriteString("file_url", formFillUrl.FileUrl);

            writer.WritePropertyName("data");
            JsonSerializer.Serialize(writer, formFillUrl.Data, jsonSerializerOptions);
            var outputRawValue = FormFillUrl.OutputEnumToJsonValue(formFillUrl.OutputOption.Value!.Value);
            writer.WriteString("output", outputRawValue);
            if (formFillUrl.NameOption.IsSet)
                writer.WriteString("name", formFillUrl.Name);
        }
    }
}
