...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject12 : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="response">Base64 encoded document if the output&#x3D;base64 is used or URL to the document when the output&#x3D;url is used.</param>
        /// <param name="meta">meta</param>
        [JsonConstructor]
        public InlineObject12(Option<string?> response = default, Option<InlineObject12Meta?> meta = default)
        {
        ...
        /// </summary>
        /// <value>Base64 encoded document if the output&#x3D;base64 is used or URL to the document when the output&#x3D;url is used.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<InlineObject12Meta?> MetaOption { get; private set; }

        /// <summary>
        /// Gets or Sets Meta
        /// </summary>
        [JsonPropertyName("meta")]
        public InlineObject12Meta? Meta { get { return this.MetaOption; } set { this.MetaOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject12" />
    /// </summary>
    public class InlineObject12JsonConverter : JsonConverter<InlineObject12>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject12" />
        /// </summary>
        ...
        public override InlineObject12 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject12Meta?> meta = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "response":
                            ...
                            break;
                        case "meta":
                            meta = new Option<InlineObject12Meta?>(JsonSerializer.Deserialize<InlineObject12Meta>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject12.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject12.");

            return new InlineObject12(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject12" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject12"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject12 inlineObject12, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject12, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject12" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject12"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject12 inlineObject12, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject12.ResponseOption.IsSet && inlineObject12.Response == null)
                throw new ArgumentNullException(nameof(inlineObject12.Response), "Property is required for class InlineObject12.");

            if (inlineObject12.MetaOption.IsSet && inlineObject12.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject12.Meta), "Property is required for class InlineObject12.");

            if (inlineObject12.ResponseOption.IsSet)
                writer.WriteString("response", inlineObject12.Response);

            if (inlineObject12.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject12.Meta, jsonSerializerOptions);
            }
        }
    }
}
