...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject6 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject6(Option<List<FormConfiguration>?> response = default, Option<PaginationMeta?> meta = default)
        {
        ...
        public Option<List<FormConfiguration>?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public List<FormConfiguration>? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObject6" />
    /// </summary>
    public class InlineObject6JsonConverter : JsonConverter<InlineObject6>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObject6" />
        /// </summary>
        ...
        public override InlineObject6 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<FormConfiguration>?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<List<FormConfiguration>?>(JsonSerializer.Deserialize<List<FormConfiguration>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject6.");

            if (meta.IsSet && meta.Value == null)
                throw new ArgumentNullException(nameof(meta), "Property is not nullable for class InlineObject6.");

            return new InlineObject6(response, meta);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObject6" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject6"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObject6 inlineObject6, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObject6, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObject6" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObject6"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObject6 inlineObject6, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObject6.ResponseOption.IsSet && inlineObject6.Response == null)
                throw new ArgumentNullException(nameof(inlineObject6.Response), "Property is required for class InlineObject6.");

            if (inlineObject6.MetaOption.IsSet && inlineObject6.Meta == null)
                throw new ArgumentNullException(nameof(inlineObject6.Meta), "Property is required for class InlineObject6.");

            if (inlineObject6.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject6.Response, jsonSerializerOptions);
            }
            if (inlineObject6.MetaOption.IsSet)
            {
                writer.WritePropertyName("meta");
                JsonSerializer.Serialize(writer, inlineObject6.Meta, jsonSerializerOptions);
            }
        }
    }
}
