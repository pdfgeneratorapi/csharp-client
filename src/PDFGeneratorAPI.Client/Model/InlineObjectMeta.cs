...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// InlineObjectMeta
    /// </summary>
    public partial class InlineObjectMeta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineObjectMeta" /> class.
        /// </summary>
        /// <param name="encoding">Document encoding</param>
        /// <param name="contentType">Document content type.</param>
        [JsonConstructor]
        public InlineObjectMeta(Option<string?> encoding = default, Option<string?> contentType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineObjectMeta {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InlineObjectMeta" />
    /// </summary>
    public class InlineObjectMetaJsonConverter : JsonConverter<InlineObjectMeta>
    {
        /// <summary>
        /// Deserializes json to <see cref="InlineObjectMeta" />
        /// </summary>
        ...
        public override InlineObjectMeta Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (encoding.IsSet && encoding.Value == null)
                throw new ArgumentNullException(nameof(encoding), "Property is not nullable for class InlineObjectMeta.");

            if (contentType.IsSet && contentType.Value == null)
                throw new ArgumentNullException(nameof(contentType), "Property is not nullable for class InlineObjectMeta.");

            return new InlineObjectMeta(encoding, contentType);
        }

        /// <summary>
        /// Serializes a <see cref="InlineObjectMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObjectMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InlineObjectMeta inlineObjectMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inlineObjectMeta, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InlineObjectMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inlineObjectMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InlineObjectMeta inlineObjectMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inlineObjectMeta.EncodingOption.IsSet && inlineObjectMeta.Encoding == null)
                throw new ArgumentNullException(nameof(inlineObjectMeta.Encoding), "Property is required for class InlineObjectMeta.");

            if (inlineObjectMeta.ContentTypeOption.IsSet && inlineObjectMeta.ContentType == null)
                throw new ArgumentNullException(nameof(inlineObjectMeta.ContentType), "Property is required for class InlineObjectMeta.");

            if (inlineObjectMeta.EncodingOption.IsSet)
                writer.WriteString("encoding", inlineObjectMeta.Encoding);

            if (inlineObjectMeta.ContentTypeOption.IsSet)
                writer.WriteString("content-type", inlineObjectMeta.ContentType);
        }
    }
}
