...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateDefinitionNewPagesInnerMargins : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDefinitionNewPagesInnerMargins" /> class.
        /// </summary>
        /// <param name="right">Page or label margin from right</param>
        /// <param name="bottom">Page or label margin from bottom</param>
        [JsonConstructor]
        public TemplateDefinitionNewPagesInnerMargins(Option<decimal?> right = default, Option<decimal?> bottom = default)
        {
            RightOption = right;
            BottomOption = bottom;
            OnCreated();
        ...
        /// </summary>
        /// <value>Page or label margin from right</value>
        /* <example>0.5</example> */
        ...
        /// </summary>
        /// <value>Page or label margin from bottom</value>
        /* <example>0.5</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateDefinitionNewPagesInnerMargins {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateDefinitionNewPagesInnerMargins" />
    /// </summary>
    public class TemplateDefinitionNewPagesInnerMarginsJsonConverter : JsonConverter<TemplateDefinitionNewPagesInnerMargins>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateDefinitionNewPagesInnerMargins" />
        /// </summary>
        ...
        public override TemplateDefinitionNewPagesInnerMargins Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (right.IsSet && right.Value == null)
                throw new ArgumentNullException(nameof(right), "Property is not nullable for class TemplateDefinitionNewPagesInnerMargins.");

            if (bottom.IsSet && bottom.Value == null)
                throw new ArgumentNullException(nameof(bottom), "Property is not nullable for class TemplateDefinitionNewPagesInnerMargins.");

            return new TemplateDefinitionNewPagesInnerMargins(right, bottom);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateDefinitionNewPagesInnerMargins" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewPagesInnerMargins"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateDefinitionNewPagesInnerMargins templateDefinitionNewPagesInnerMargins, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateDefinitionNewPagesInnerMargins, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateDefinitionNewPagesInnerMargins" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateDefinitionNewPagesInnerMargins"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateDefinitionNewPagesInnerMargins templateDefinitionNewPagesInnerMargins, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateDefinitionNewPagesInnerMargins.RightOption.IsSet)
                writer.WriteNumber("right", templateDefinitionNewPagesInnerMargins.RightOption.Value!.Value);

            if (templateDefinitionNewPagesInnerMargins.BottomOption.IsSet)
                writer.WriteNumber("bottom", templateDefinitionNewPagesInnerMargins.BottomOption.Value!.Value);
        }
    }
}
