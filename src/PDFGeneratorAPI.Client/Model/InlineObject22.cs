...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class InlineObject22 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public InlineObject22(Option<InlineObject22Response?> response = default)
        {
        ...
        public Option<InlineObject22Response?> ResponseOption { get; private set; }

        /// <summary>
        /// Gets or Sets Response
        /// </summary>
        [JsonPropertyName("response")]
        public InlineObject22Response? Response { get { return this.ResponseOption; } set { this.ResponseOption = new(value); } }
    ...
    public class InlineObject22JsonConverter : JsonConverter<InlineObject22>
    {
        ...
        public override InlineObject22 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InlineObject22Response?> response = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "response":
                            response = new Option<InlineObject22Response?>(JsonSerializer.Deserialize<InlineObject22Response>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (response.IsSet && response.Value == null)
                throw new ArgumentNullException(nameof(response), "Property is not nullable for class InlineObject22.");

            return new InlineObject22(response);
        }
        ...
        {
            if (inlineObject22.ResponseOption.IsSet && inlineObject22.Response == null)
                throw new ArgumentNullException(nameof(inlineObject22.Response), "Property is required for class InlineObject22.");

            if (inlineObject22.ResponseOption.IsSet)
            {
                writer.WritePropertyName("response");
                JsonSerializer.Serialize(writer, inlineObject22.Response, jsonSerializerOptions);
            }
        }
    }
}
