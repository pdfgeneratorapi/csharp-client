...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// TemplateParamData
    /// </summary>
    public partial class TemplateParamData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateParamData" /> class.
        /// </summary>
        /// <param name="object"></param>
        internal TemplateParamData(Object @object)
        {
            Object = @object;
            OnCreated();
        }
        ...
        internal TemplateParamData(List<Object> list)
        {
            List = list;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateParamData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateParamData" />
    /// </summary>
    public class TemplateParamDataJsonConverter : JsonConverter<TemplateParamData>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateParamData" />
        /// </summary>
        ...
        public override TemplateParamData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (varObject != null)
                return new TemplateParamData(varObject);

            if (list != null)
                return new TemplateParamData(list);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="TemplateParamData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateParamData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateParamData templateParamData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateParamData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateParamData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateParamData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateParamData templateParamData, JsonSerializerOptions jsonSerializerOptions)
        {
