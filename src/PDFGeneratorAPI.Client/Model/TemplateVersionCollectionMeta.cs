...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    /// </summary>
    public partial class TemplateVersionCollectionMeta : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateVersionCollectionMeta" /> class.
        /// </summary>
        /// <param name="currentPage">currentPage</param>
        /// <param name="perPage">perPage</param>
        /// <param name="lastPage">lastPage</param>
        [JsonConstructor]
        public TemplateVersionCollectionMeta(Option<int?> currentPage = default, Option<int?> perPage = default, Option<int?> lastPage = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateVersionCollectionMeta {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="TemplateVersionCollectionMeta" />
    /// </summary>
    public class TemplateVersionCollectionMetaJsonConverter : JsonConverter<TemplateVersionCollectionMeta>
    {
        /// <summary>
        /// Deserializes json to <see cref="TemplateVersionCollectionMeta" />
        /// </summary>
        ...
        public override TemplateVersionCollectionMeta Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class TemplateVersionCollectionMeta.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class TemplateVersionCollectionMeta.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class TemplateVersionCollectionMeta.");

            return new TemplateVersionCollectionMeta(currentPage, perPage, lastPage);
        }

        /// <summary>
        /// Serializes a <see cref="TemplateVersionCollectionMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateVersionCollectionMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TemplateVersionCollectionMeta templateVersionCollectionMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, templateVersionCollectionMeta, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TemplateVersionCollectionMeta" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="templateVersionCollectionMeta"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TemplateVersionCollectionMeta templateVersionCollectionMeta, JsonSerializerOptions jsonSerializerOptions)
        {
            if (templateVersionCollectionMeta.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", templateVersionCollectionMeta.CurrentPageOption.Value!.Value);

            if (templateVersionCollectionMeta.PerPageOption.IsSet)
                writer.WriteNumber("per_page", templateVersionCollectionMeta.PerPageOption.Value!.Value);

            if (templateVersionCollectionMeta.LastPageOption.IsSet)
                writer.WriteNumber("last_page", templateVersionCollectionMeta.LastPageOption.Value!.Value);
        }
    }
}
