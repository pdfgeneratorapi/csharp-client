...
namespace PDFGeneratorAPI.Client.Model
{
    ...
    public partial class Template : IValidatableObject
    {
        ...
        /// <param name="owner">Indicates if the workspace is the owner of the template</param>
        /// <param name="createdAt">Timestamp when the template was created</param>
        /// <param name="updatedAt">Timestamp when the template was updated</param>
        /// <param name="tags">A list of tags assigned to a template</param>
        [JsonConstructor]
        public Template(Option<int?> id = default, Option<string?> name = default, Option<bool?> owner = default, Option<string?> createdAt = default, Option<string?> updatedAt = default, Option<List<string>?> tags = default)
        {
            IdOption = id;
            NameOption = name;
            OwnerOption = owner;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> OwnerOption { get; private set; }

        /// <summary>
        /// Indicates if the workspace is the owner of the template
        /// </summary>
        /// <value>Indicates if the workspace is the owner of the template</value>
        /* <example>true</example> */
        [JsonPropertyName("owner")]
        public bool? Owner { get { return this.OwnerOption; } set { this.OwnerOption = new(value); } }
        ...
        /// </summary>
        /// <value>Timestamp when the template was created</value>
        /* <example>2022-01-21 11:49:28</example> */
        ...
        /// </summary>
        /// <value>Timestamp when the template was updated</value>
        /* <example>2022-08-01 23:49:28</example> */
    ...
    public class TemplateJsonConverter : JsonConverter<Template>
    {
        ...
        public override Template Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (owner.IsSet && owner.Value == null)
                throw new ArgumentNullException(nameof(owner), "Property is not nullable for class Template.");
            ...
            if (tags.IsSet && tags.Value == null)
                throw new ArgumentNullException(nameof(tags), "Property is not nullable for class Template.");

            return new Template(id, name, owner, createdAt, updatedAt, tags);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Template template, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (template.CreatedAtOption.IsSet && template.CreatedAt == null)
                throw new ArgumentNullException(nameof(template.CreatedAt), "Property is required for class Template.");

            if (template.UpdatedAtOption.IsSet && template.UpdatedAt == null)
                throw new ArgumentNullException(nameof(template.UpdatedAt), "Property is required for class Template.");

            if (template.TagsOption.IsSet && template.Tags == null)
                throw new ArgumentNullException(nameof(template.Tags), "Property is required for class Template.");

            if (template.IdOption.IsSet)
                writer.WriteNumber("id", template.IdOption.Value!.Value);

            if (template.NameOption.IsSet)
                writer.WriteString("name", template.Name);

            if (template.OwnerOption.IsSet)
                writer.WriteBoolean("owner", template.OwnerOption.Value!.Value);

            if (template.CreatedAtOption.IsSet)
                writer.WriteString("created_at", template.CreatedAt);

            if (template.UpdatedAtOption.IsSet)
                writer.WriteString("updated_at", template.UpdatedAt);

            if (template.TagsOption.IsSet)
            {
                writer.WritePropertyName("tags");
                JsonSerializer.Serialize(writer, template.Tags, jsonSerializerOptions);
            }
        }
    }
}
