...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    public sealed class FormsApiTests : ApiTestsBase
    {
        ...
        public async Task CreateFormAsyncTest()
        {
            FormConfigurationNew formConfigurationNew = default!;
            var response = await _instance.CreateFormAsync(formConfigurationNew);
            var model = response.Created();
            Assert.IsType<InlineObject19>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteFormAsyncTest()
        {
            int formId = default!;
            await _instance.DeleteFormAsync(formId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetFormAsyncTest()
        {
            int formId = default!;
            var response = await _instance.GetFormAsync(formId);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetFormsAsyncTest()
        {
            Client.Option<int> page = default!;
            Client.Option<int> perPage = default!;
            var response = await _instance.GetFormsAsync(page, perPage);
            var model = response.Ok();
            Assert.IsType<InlineObject6>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ImportFormAsyncTest()
        {
            ImportFormRequest importFormRequest = default!;
            var response = await _instance.ImportFormAsync(importFormRequest);
            var model = response.Created();
            Assert.IsType<InlineObject19>(model);
        }

        /// <summary>
        /// Test OpenFormBuilder
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task OpenFormBuilderAsyncTest()
        {
            var response = await _instance.OpenFormBuilderAsync();
            var model = response.Created();
            Assert.IsType<InlineObject21>(model);
        }

        /// <summary>
        /// Test OpenFormBuilderForExistingForm
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task OpenFormBuilderForExistingFormAsyncTest()
        {
            int formId = default!;
            var response = await _instance.OpenFormBuilderForExistingFormAsync(formId);
            var model = response.Created();
            Assert.IsType<InlineObject21>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ShareFormAsyncTest()
        {
            int formId = default!;
            var response = await _instance.ShareFormAsync(formId);
            var model = response.Created();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateFormAsyncTest()
        {
            int formId = default!;
            FormConfigurationNew formConfigurationNew = default!;
            var response = await _instance.UpdateFormAsync(formId, formConfigurationNew);
            var model = response.Ok();
            Assert.IsType<InlineObject19>(model);
        }
    }
