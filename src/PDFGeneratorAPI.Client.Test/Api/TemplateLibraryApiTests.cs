...
{
    /// <summary>
    ///  Class for testing TemplateLibraryApi
    /// </summary>
    public sealed class TemplateLibraryApiTests : ApiTestsBase
    {
        private readonly ITemplateLibraryApi _instance;

        public TemplateLibraryApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ITemplateLibraryApi>();
        }

        /// <summary>
        /// Test GetTemplateLibrary
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetTemplateLibraryAsyncTest()
        {
            Client.Option<string> tags = default!;
            var response = await _instance.GetTemplateLibraryAsync(tags);
            var model = response.Ok();
            Assert.IsType<GetTemplateLibrary200Response>(model);
        }

        /// <summary>
        /// Test GetTemplateLibraryItem
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetTemplateLibraryItemAsyncTest()
        {
            string publicId = default!;
            var response = await _instance.GetTemplateLibraryItemAsync(publicId);
            var model = response.Ok();
