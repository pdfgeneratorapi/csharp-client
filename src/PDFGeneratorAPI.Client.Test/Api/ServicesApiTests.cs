...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    /// </summary>
    public sealed class ServicesApiTests : ApiTestsBase
    {
        private readonly IServicesApi _instance;

        public ServicesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IServicesApi>();
        }
        ...
        public async Task AddWatermarkAsyncTest()
        {
            AddWatermarkRequest addWatermarkRequest = default!;
            var response = await _instance.AddWatermarkAsync(addWatermarkRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test DecryptDocument
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DecryptDocumentAsyncTest()
        {
            EncryptDocumentRequest encryptDocumentRequest = default!;
            var response = await _instance.DecryptDocumentAsync(encryptDocumentRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test EncryptDocument
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task EncryptDocumentAsyncTest()
        {
            EncryptDocumentRequest encryptDocumentRequest = default!;
            var response = await _instance.EncryptDocumentAsync(encryptDocumentRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ExtractFormFieldsAsyncTest()
        {
            ExtractFormFieldsRequest extractFormFieldsRequest = default!;
            var response = await _instance.ExtractFormFieldsAsync(extractFormFieldsRequest);
            var model = response.Ok();
            Assert.IsType<InlineObject14>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task FillFormFieldsAsyncTest()
        {
            FillFormFieldsRequest fillFormFieldsRequest = default!;
            var response = await _instance.FillFormFieldsAsync(fillFormFieldsRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task MakeAccessibleAsyncTest()
        {
            MakeAccessibleRequest makeAccessibleRequest = default!;
            var response = await _instance.MakeAccessibleAsync(makeAccessibleRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task OptimizeDocumentAsyncTest()
        {
            OptimizeDocumentRequest optimizeDocumentRequest = default!;
            var response = await _instance.OptimizeDocumentAsync(optimizeDocumentRequest);
            var model = response.Created();
            Assert.IsType<InlineObject12>(model);
        }
    }
}
