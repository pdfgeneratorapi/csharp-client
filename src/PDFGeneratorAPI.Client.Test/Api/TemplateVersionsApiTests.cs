...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    /// </summary>
    public sealed class TemplateVersionsApiTests : ApiTestsBase
    {
        private readonly ITemplateVersionsApi _instance;

        public TemplateVersionsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ITemplateVersionsApi>();
        }

        /// <summary>
        /// Test DeleteTemplateVersion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteTemplateVersionAsyncTest()
        {
            int templateId = default!;
            int templateVersion = default!;
            await _instance.DeleteTemplateVersionAsync(templateId, templateVersion);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetTemplateVersionAsyncTest()
        {
            int templateId = default!;
            int templateVersion = default!;
            var response = await _instance.GetTemplateVersionAsync(templateId, templateVersion);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListTemplateVersionsAsyncTest()
        {
            int templateId = default!;
            Client.Option<int> perPage = default!;
            Client.Option<int> page = default!;
            var response = await _instance.ListTemplateVersionsAsync(templateId, perPage, page);
            var model = response.Ok();
            Assert.IsType<TemplateVersionCollection>(model);
        }

        /// <summary>
        /// Test PromoteTemplateVersion
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task PromoteTemplateVersionAsyncTest()
        {
            int templateId = default!;
            int templateVersion = default!;
            var response = await _instance.PromoteTemplateVersionAsync(templateId, templateVersion);
            var model = response.Ok();
            Assert.IsType<PromoteTemplateVersion200Response>(model);
        }
    }
}
