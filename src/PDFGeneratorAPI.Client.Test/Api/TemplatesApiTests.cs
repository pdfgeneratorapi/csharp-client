...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    public sealed class TemplatesApiTests : ApiTestsBase
    {
        ...
        public async Task CopyTemplateAsyncTest()
        {
            int templateId = default!;
            Client.Option<CopyTemplateRequest> copyTemplateRequest = default!;
            var response = await _instance.CopyTemplateAsync(templateId, copyTemplateRequest);
            var model = response.Created();
            Assert.IsType<InlineObject18>(model);
        }
        ...
        {
            TemplateDefinitionNew templateDefinitionNew = default!;
            var response = await _instance.CreateTemplateAsync(templateDefinitionNew);
            var model = response.Created();
            Assert.IsType<InlineObject18>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetTemplateDataAsyncTest()
        {
            int templateId = default!;
            var response = await _instance.GetTemplateDataAsync(templateId);
            var model = response.Ok();
            Assert.IsType<InlineObject2>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetTemplateSchemaAsyncTest()
        {
            var response = await _instance.GetTemplateSchemaAsync();
            var model = response.Ok();
        ...
        public async Task GetTemplatesAsyncTest()
        {
            ...
            var response = await _instance.GetTemplatesAsync(name, tags, access, page, perPage);
            var model = response.Ok();
            Assert.IsType<InlineObject4>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ImportTemplateAsyncTest()
        {
            ImportTemplateRequest importTemplateRequest = default!;
            var response = await _instance.ImportTemplateAsync(importTemplateRequest);
            var model = response.Created();
            Assert.IsType<InlineObject18>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task OpenEditorAsyncTest()
        {
            int templateId = default!;
            OpenEditorRequest openEditorRequest = default!;
            var response = await _instance.OpenEditorAsync(templateId, openEditorRequest);
            var model = response.Ok();
            Assert.IsType<InlineObject3>(model);
        }
        ...
        public async Task UpdateTemplateAsyncTest()
        {
            int templateId = default!;
            TemplateDefinitionNew templateDefinitionNew = default!;
            var response = await _instance.UpdateTemplateAsync(templateId, templateDefinitionNew);
            var model = response.Ok();
            Assert.IsType<InlineObject18>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ValidateTemplateAsyncTest()
        {
            TemplateDefinitionNew templateDefinitionNew = default!;
            var response = await _instance.ValidateTemplateAsync(templateDefinitionNew);
            var model = response.Ok();
            Assert.IsType<InlineObject1>(model);
        }
    }
}
