...
{
    /// <summary>
    ///  Class for testing EInvoicesApi
    /// </summary>
    public sealed class EInvoicesApiTests : ApiTestsBase
    {
        private readonly IEInvoicesApi _instance;

        public EInvoicesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IEInvoicesApi>();
        }
        ...
        public async Task CreateEInvoiceAsyncTest()
        {
            CreateEInvoiceRequest createEInvoiceRequest = default!;
            var response = await _instance.CreateEInvoiceAsync(createEInvoiceRequest);
            var model = response.Created();
            Assert.IsType<InlineObject>(model);
        }

        /// <summary>
        /// Test CreateFacturXEInvoice
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateFacturXEInvoiceAsyncTest()
        {
            CreateFacturXEInvoiceRequest createFacturXEInvoiceRequest = default!;
            var response = await _instance.CreateFacturXEInvoiceAsync(createFacturXEInvoiceRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test CreateXRechnungEInvoice
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateXRechnungEInvoiceAsyncTest()
        {
            CreateEInvoiceRequest createEInvoiceRequest = default!;
            var response = await _instance.CreateXRechnungEInvoiceAsync(createEInvoiceRequest);
            var model = response.Created();
            Assert.IsType<InlineObject>(model);
        }

        /// <summary>
        /// Test GetEInvoiceSchema
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetEInvoiceSchemaAsyncTest()
        {
            var response = await _instance.GetEInvoiceSchemaAsync();
