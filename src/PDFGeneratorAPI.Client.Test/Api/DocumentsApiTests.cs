...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    /// </summary>
    public sealed class DocumentsApiTests : ApiTestsBase
    {
        private readonly IDocumentsApi _instance;

        public DocumentsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDocumentsApi>();
        }
        ...
        public async Task DeleteDocumentAsyncTest()
        {
            ...
            await _instance.DeleteDocumentAsync(publicId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateDocumentAsyncTest()
        {
            GenerateDocumentRequest generateDocumentRequest = default!;
            var response = await _instance.GenerateDocumentAsync(generateDocumentRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test GenerateDocumentAsynchronous
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateDocumentAsynchronousAsyncTest()
        {
            GenerateDocumentAsynchronousRequest generateDocumentAsynchronousRequest = default!;
            var response = await _instance.GenerateDocumentAsynchronousAsync(generateDocumentAsynchronousRequest);
            var model = response.Created();
            Assert.IsType<InlineObject22>(model);
        }

        /// <summary>
        /// Test GenerateDocumentBatch
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateDocumentBatchAsyncTest()
        {
            GenerateDocumentBatchRequest generateDocumentBatchRequest = default!;
            var response = await _instance.GenerateDocumentBatchAsync(generateDocumentBatchRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test GenerateDocumentBatchAsynchronous
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateDocumentBatchAsynchronousAsyncTest()
        {
            GenerateDocumentBatchAsynchronousRequest generateDocumentBatchAsynchronousRequest = default!;
            var response = await _instance.GenerateDocumentBatchAsynchronousAsync(generateDocumentBatchAsynchronousRequest);
            var model = response.Created();
            Assert.IsType<InlineObject22>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetAsyncJobStatusAsyncTest()
        {
            string jobId = default!;
            var response = await _instance.GetAsyncJobStatusAsync(jobId);
            var model = response.Ok();
            Assert.IsType<InlineObject13>(model);
        }
        ...
        {
            string publicId = default!;
            var response = await _instance.GetDocumentAsync(publicId);
            var model = response.Ok();
            Assert.IsType<InlineObject11>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDocumentActionsAsyncTest()
        {
            string publicId = default!;
            var response = await _instance.GetDocumentActionsAsync(publicId);
            var model = response.Ok();
            Assert.IsType<InlineObject17>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetDocumentVersionsAsyncTest()
        {
            string publicId = default!;
            var response = await _instance.GetDocumentVersionsAsync(publicId);
            var model = response.Ok();
            Assert.IsType<InlineObject16>(model);
        }
        ...
        {
            Client.Option<int> templateId = default!;
            ...
            var response = await _instance.GetDocumentsAsync(templateId, startDate, endDate, page, perPage);
            var model = response.Ok();
            Assert.IsType<InlineObject15>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task StoreDocumentAsyncTest()
        {
            StoreDocumentRequest storeDocumentRequest = default!;
            var response = await _instance.StoreDocumentAsync(storeDocumentRequest);
            var model = response.Created();
            Assert.IsType<InlineObject11>(model);
        }
    }
