...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    /// </summary>
    public sealed class ConversionApiTests : ApiTestsBase
    {
        private readonly IConversionApi _instance;

        public ConversionApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IConversionApi>();
        }

        /// <summary>
        /// Test ConvertHTML2PDF
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ConvertHTML2PDFAsyncTest()
        {
            ConvertHTML2PDFRequest convertHTML2PDFRequest = default!;
            var response = await _instance.ConvertHTML2PDFAsync(convertHTML2PDFRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }

        /// <summary>
        /// Test ConvertPDF2Image
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ConvertPDF2ImageAsyncTest()
        {
            ConvertPDF2ImageRequest convertPDF2ImageRequest = default!;
            var response = await _instance.ConvertPDF2ImageAsync(convertPDF2ImageRequest);
            var model = response.Created();
            Assert.IsType<InlineObject10>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ConvertURL2PDFAsyncTest()
        {
            ConvertURL2PDFRequest convertURL2PDFRequest = default!;
            var response = await _instance.ConvertURL2PDFAsync(convertURL2PDFRequest);
            var model = response.Created();
            Assert.IsType<InlineObject9>(model);
        }
    }
