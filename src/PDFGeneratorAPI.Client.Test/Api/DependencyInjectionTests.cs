...
using PDFGeneratorAPI.Client.Extensions;
using Xunit;

namespace PDFGeneratorAPI.Client.Test.Api
{
    /// <summary>
    ...
    public class DependencyInjectionTest
    {
        ...
        public void ConfigureApiWithAClientTest()
        {
            ...
            var conversionApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IConversionApi>();
            Assert.True(conversionApi.HttpClient.BaseAddress != null);

            var documentsApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IDocumentsApi>();
            Assert.True(documentsApi.HttpClient.BaseAddress != null);

            var eInvoicesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IEInvoicesApi>();
            Assert.True(eInvoicesApi.HttpClient.BaseAddress != null);
            ...
            var servicesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IServicesApi>();
            Assert.True(servicesApi.HttpClient.BaseAddress != null);

            var templateLibraryApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<ITemplateLibraryApi>();
            Assert.True(templateLibraryApi.HttpClient.BaseAddress != null);

            var templateVersionsApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<ITemplateVersionsApi>();
            Assert.True(templateVersionsApi.HttpClient.BaseAddress != null);
        ...
        public void ConfigureApiWithoutAClientTest()
        {
            ...
            var conversionApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IConversionApi>();
            Assert.True(conversionApi.HttpClient.BaseAddress != null);

            var documentsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IDocumentsApi>();
            Assert.True(documentsApi.HttpClient.BaseAddress != null);

            var eInvoicesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IEInvoicesApi>();
            Assert.True(eInvoicesApi.HttpClient.BaseAddress != null);
            ...
            var servicesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IServicesApi>();
            Assert.True(servicesApi.HttpClient.BaseAddress != null);

            var templateLibraryApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<ITemplateLibraryApi>();
            Assert.True(templateLibraryApi.HttpClient.BaseAddress != null);

            var templateVersionsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<ITemplateVersionsApi>();
            Assert.True(templateVersionsApi.HttpClient.BaseAddress != null);
        ...
        public void AddApiWithAClientTest()
        {
            ...
            var conversionApi = _hostUsingAddWithAClient.Services.GetRequiredService<IConversionApi>();
            Assert.True(conversionApi.HttpClient.BaseAddress != null);
            
            var documentsApi = _hostUsingAddWithAClient.Services.GetRequiredService<IDocumentsApi>();
            Assert.True(documentsApi.HttpClient.BaseAddress != null);
            
            var eInvoicesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IEInvoicesApi>();
            Assert.True(eInvoicesApi.HttpClient.BaseAddress != null);
            ...
            var servicesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IServicesApi>();
            Assert.True(servicesApi.HttpClient.BaseAddress != null);
            
            var templateLibraryApi = _hostUsingAddWithAClient.Services.GetRequiredService<ITemplateLibraryApi>();
            Assert.True(templateLibraryApi.HttpClient.BaseAddress != null);
            
            var templateVersionsApi = _hostUsingAddWithAClient.Services.GetRequiredService<ITemplateVersionsApi>();
            Assert.True(templateVersionsApi.HttpClient.BaseAddress != null);
        ...
        public void AddApiWithoutAClientTest()
        {
            ...
            var conversionApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IConversionApi>();
            Assert.True(conversionApi.HttpClient.BaseAddress != null);

            var documentsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IDocumentsApi>();
            Assert.True(documentsApi.HttpClient.BaseAddress != null);

            var eInvoicesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IEInvoicesApi>();
            Assert.True(eInvoicesApi.HttpClient.BaseAddress != null);
            ...
            var servicesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IServicesApi>();
            Assert.True(servicesApi.HttpClient.BaseAddress != null);

            var templateLibraryApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<ITemplateLibraryApi>();
            Assert.True(templateLibraryApi.HttpClient.BaseAddress != null);

            var templateVersionsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<ITemplateVersionsApi>();
            Assert.True(templateVersionsApi.HttpClient.BaseAddress != null);
