...
namespace PDFGeneratorAPI.Client.Test.Api
{
    ...
    public sealed class WorkspacesApiTests : ApiTestsBase
    {
        ...
        {
            Client.Option<CreateWorkspaceRequest> createWorkspaceRequest = default!;
            var response = await _instance.CreateWorkspaceAsync(createWorkspaceRequest);
            var model = response.Created();
            Assert.IsType<InlineObject8>(model);
        }
        ...
        {
            string workspaceIdentifier = default!;
            await _instance.DeleteWorkspaceAsync(workspaceIdentifier);
        }
        ...
        {
            string workspaceIdentifier = default!;
            var response = await _instance.GetWorkspaceAsync(workspaceIdentifier);
        ...
        public async Task GetWorkspacesAsyncTest()
        {
            ...
            var response = await _instance.GetWorkspacesAsync(page, perPage);
            var model = response.Ok();
            Assert.IsType<InlineObject5>(model);
        }
    }
}
